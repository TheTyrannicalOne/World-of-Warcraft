...
PLH_DEBUG							= 'PLH_DEBUG'
PLH_AUTO_HIDE						= 'PLH_AUTO_HIDE'
PLH_SKIP_CONFIRMATION				= 'PLH_SKIP_CONFIRMATION'
PLH_ONLY_OFFER_IF_UPGRADE			= 'PLH_ONLY_OFFER_IF_UPGRADE'
PLH_NEVER_OFFER_BOE					= 'PLH_NEVER_OFFER_BOE'
PLH_CURRENT_SPEC_ONLY				= 'PLH_CURRENT_SPEC_ONLY'
PLH_ILVL_THRESHOLD					= 'PLH_ILVL_THRESHOLD'
PLH_INCLUDE_XMOG					= 'PLH_INCLUDE_XMOG'
PLH_WHISPER_MESSAGE					= 'PLH_WHISPER_MESSAGE'
