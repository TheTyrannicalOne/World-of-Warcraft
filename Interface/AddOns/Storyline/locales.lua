...
— Arthur Rimbaud]=],
	...
	["SL_CONFIG_DISABLE_IN_DMF"] = "Désactiver sur l’île de Sombrelune",
	["SL_CONFIG_DISABLE_IN_DMF_TT"] = "Désactiver automatiquement Storyline lorsque vous êtes sur l'île de Sombrelune.",
		...
		localeContent =
{
	...
	["SL_CONFIG_DIALOG_CHOICES"] = "對話內容選項",
