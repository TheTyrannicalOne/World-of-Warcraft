...
L["If checked, you can hold down the alt key while opening a gossip window to automatically select a single gossip option."] = "勾选后，你可以按住ALT键来自动交互只有一个选项的对话情景。"
...
L["If checked, you will be able to change the position and scale of the player frame, target frame, buff frame, widget top center frame, ghost frame and timer bar."] = "勾选后，你可以改边玩家框体、目标框体、Buff栏位、顶部信息面板、灵魂面板和计时条的位置和大小。"
...
L["If checked, your gear will be repaired automatically when you visit a suitable merchant.|n|nGuild funds will be used if possible otherwise character funds will be used.|n|nYou can hold the shift key down when you talk to a merchant to override this setting."] = "勾选后，当你打开一个可供修理的商贩时，会自动修理身上的装备。|n|n插件会优先使用公会的修理经费。|n|n当你打开商贩时，按住SHIFT键会让你当下忽略此项功能。"
...
L["If checked, you can hold down the alt key while opening a gossip window to automatically select a single gossip option."] = "勾選後，你可以在開啟對話時按下Alt鍵以自動選擇單個的對話選項。"
...
L["If checked, you will be able to change the position and scale of the player frame, target frame, buff frame, widget top center frame, ghost frame and timer bar."] = "勾選後，你可以變更玩家框架、目標框架、增益框架、頂部中央部件框架、靈魂框架與計時器的位置和大小。"
...
L["An Unclear Path"] = "Неясный путь"
...
L["Atal'Dazar"] = "어두운 토양 검사 활성화. 리로드-종료."
...
L["If checked, you can hold down the alt key while opening a gossip window to automatically select a single gossip option."] = "Alt키를 누른 상태에서 대화 창을 열면 대화를 선택할수 있습니다."
...
L["If checked, you will be able to change the position and scale of the player frame, target frame, buff frame, widget top center frame, ghost frame and timer bar."] = "플레이어,대상,버프,유령...프레임 위치와 크기를 변경할수 있습니다."
...
L["If checked, you will be able to place up to five beneficial cooldown icons above the target frame."] = "대상창 위에 최대 5개의 쿨다운 아이콘을 배치 할 수 있습니다."
...
L["If checked, your gear will be repaired automatically when you visit a suitable merchant.|n|nGuild funds will be used if possible otherwise character funds will be used.|n|nYou can hold the shift key down when you talk to a merchant to override this setting."] = "상인을 방문 할때 장비가 자동으로 수리됩니다.|n|n길드자금이 사용 가능한 경우 우선 사용 됩니다.|n|nShift키 누른채 대화시 자동 무시."
...
L["Shrine of the Storm"] = "퀘스트 진행상황 메시지는 표시됩니다."
L["Siege of Boralus"] = "전투중 월드유닛 툴팁 숨김"
...
L["Temple of Sethraliss"] = "미니맵 지역정보 숨김. 추적 툴팁에 대신 표시"
...
L["Tol Barad"] = "톨 바라드"
L["Tol Dagor"] = "플레이어 또는 대상 프레임(블리자드 유닛 프레임) 위에 5개 쿨다운 아이콘을 설정 표시 할수 있습니다.(전문화별 저장)"
