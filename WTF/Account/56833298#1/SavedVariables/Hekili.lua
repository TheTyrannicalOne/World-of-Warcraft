				...
				["Fire"] = {
					...
					["lists"] = {
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "firestarter.active & action.rune_of_power.charges = 2 || cooldown.combustion.remains > 40 & buff.combustion.down & ! talent.kindling.enabled || target.time_to_die < 11 || talent.kindling.enabled & ( charges_fractional > 1.8 || time < 40 ) & cooldown.combustion.remains > 40",
								["action"] = "rune_of_power",
							}, -- [3]
							{
								["enabled"] = true,
								["criteria"] = "buff.pyroclasm.react & ( cooldown.combustion.remains > 40 || action.rune_of_power.charges > 1 )",
								["action"] = "rune_of_power",
							}, -- [4]
							{
								["enabled"] = true,
								["criteria"] = "cooldown.combustion.remains <= action.rune_of_power.cast_time + ( ! talent.kindling.enabled * gcd ) & ( ! talent.firestarter.enabled || ! firestarter.active || active_enemies >= 4 || active_enemies >= 2 & talent.flame_patch.enabled ) || buff.combustion.up",
								["action"] = "call_action_list",
						...
						["combustion_phase"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.pyroclasm.react & buff.combustion.remains > execute_time",
								["action"] = "pyroblast",
							}, -- [12]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.heating_up.react",
								["action"] = "fire_blast",
							}, -- [14]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "! buff.hot_streak.react & action.fire_blast.charges < 1",
						...
						["active_talents"] = {
							{
								["enabled"] = true,
								["criteria"] = "( buff.combustion.down ) || ( buff.combustion.up & action.fire_blast.charges < 1 )",
								["action"] = "blast_wave",
							}, -- [1]
							{
								["enabled"] = true,
								["criteria"] = "cooldown.combustion.remains > 40 || ( cooldown.combustion.remains > target.time_to_die ) || buff.rune_of_power.up || firestarter.active",
								["action"] = "meteor",
							}, -- [2]
							{
								["enabled"] = true,
								["criteria"] = "talent.alexstraszas_fury.enabled & ! buff.hot_streak.react",
								["action"] = "dragons_breath",
							}, -- [3]
							{
								["enabled"] = true,
						...
						["standard_rotation"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.hot_streak.react & firestarter.active & ! talent.rune_of_power.enabled",
								["action"] = "pyroblast",
							}, -- [3]
							{
								["enabled"] = true,
								["criteria"] = "charges_fractional > 2.7 & active_enemies > 2",
								["action"] = "phoenix_flames",
							}, -- [4]
							{
								["enabled"] = true,
								["criteria"] = "buff.hot_streak.react & ( ! prev_gcd.1.pyroblast || action.pyroblast.in_flight )",
								["action"] = "pyroblast",
							}, -- [5]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.pyroclasm.react & execute_time < buff.pyroclasm.remains",
								["action"] = "pyroblast",
							}, -- [7]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "! talent.kindling.enabled & buff.heating_up.react & ( ! talent.rune_of_power.enabled || charges_fractional > 1.4 || cooldown.combustion.remains < 40 ) & ( 3 - charges_fractional ) * ( 12 * spell_haste ) < cooldown.combustion.remains + 3 || target.time_to_die < 4",
								["action"] = "fire_blast",
							}, -- [9]
							{
								["enabled"] = true,
								["criteria"] = "talent.kindling.enabled & buff.heating_up.react & ( ! talent.rune_of_power.enabled || charges_fractional > 1.5 || cooldown.combustion.remains < 40 ) & ( 3 - charges_fractional ) * ( 18 * spell_haste ) < cooldown.combustion.remains + 3 || target.time_to_die < 4",
								["action"] = "fire_blast",
							}, -- [10]
							{
								["enabled"] = true,
								["criteria"] = "( buff.combustion.up || buff.rune_of_power.up || buff.incanters_flow.stack > 3 || talent.mirror_image.enabled ) & ( 4 - charges_fractional ) * 13 < cooldown.combustion.remains + 5 || target.time_to_die < 10",
								["action"] = "phoenix_flames",
							}, -- [11]
							{
								["enabled"] = true,
								["criteria"] = "( buff.combustion.up || buff.rune_of_power.up ) & ( 4 - charges_fractional ) * 30 < cooldown.combustion.remains + 5",
								["action"] = "phoenix_flames",
							}, -- [12]
							{
								["enabled"] = true,
								["criteria"] = "charges_fractional > 2.5 & cooldown.combustion.remains > 23",
								["action"] = "phoenix_flames",
							}, -- [13]
							{
								["enabled"] = true,
								["criteria"] = "( target.health.pct <= 30 & talent.searing_touch.enabled ) || ( azerite.preheat.enabled & debuff.preheat.down )",
								["action"] = "scorch",
							}, -- [14]
							{
								["action"] = "fireball",
						...
						["rop_phase"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.pyroclasm.react & execute_time < buff.pyroclasm.remains & buff.rune_of_power.remains > cast_time",
								["action"] = "pyroblast",
							}, -- [5]
							{
								["enabled"] = true,
								["criteria"] = "! prev_off_gcd.fire_blast & buff.heating_up.react & firestarter.active & charges_fractional > 1.7",
								["action"] = "fire_blast",
							}, -- [6]
							{
								["enabled"] = true,
								["criteria"] = "! prev_gcd.1.phoenix_flames & charges_fractional > 2.7 & firestarter.active",
								["action"] = "phoenix_flames",
							}, -- [7]
							{
								["enabled"] = true,
								["criteria"] = "! prev_off_gcd.fire_blast & ! firestarter.active",
								["action"] = "fire_blast",
							}, -- [8]
							{
								["enabled"] = true,
								["criteria"] = "! prev_gcd.1.phoenix_flames",
								["action"] = "phoenix_flames",
							}, -- [9]
							{
								["enabled"] = true,
				...
				["Feral"] = {
					...
					["lists"] = {
						["opener"] = {
							{
								["enabled"] = true,
								["criteria"] = "variable.delayed_tf_opener = 0",
								["action"] = "tigers_fury",
							}, -- [1]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "! ticking || buff.bloodtalons.stack = 1 & combo_points < 5",
								["action"] = "moonfire_cat",
							}, -- [5]
							{
								["enabled"] = true,
								["criteria"] = "! ticking & combo_points < 5",
								["action"] = "thrash",
							}, -- [6]
							{
								["enabled"] = true,
								["criteria"] = "spell_targets > 1 & combo_points < 5",
								["action"] = "brutal_slash",
							}, -- [7]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "combo_points = 5 & talent.bloodtalons.enabled & ( talent.sabertooth.enabled & buff.bloodtalons.down || buff.predatory_swiftness.up )",
								["action"] = "regrowth",
							}, -- [10]
							{
								["action"] = "tigers_fury",
						...
						["precombat"] = {
							...
							}, -- [5]
							{
								...
								["value"] = "1",
								["var_name"] = "use_thrash",
								["criteria"] = "azerite.power_of_the_moon.enabled",
							}, -- [6]
							{
								["value"] = "0",
								["var_name"] = "delayed_tf_opener",
								["action"] = "variable",
								["enabled"] = true,
							}, -- [7]
							{
								...
								["value"] = "1",
								["var_name"] = "delayed_tf_opener",
								["criteria"] = "talent.sabertooth.enabled & talent.bloodtalons.enabled & ! talent.lunar_inspiration.enabled",
							}, -- [8]
							{
								["action"] = "prowl",
								["enabled"] = true,
						...
						["cooldowns"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.incarnation.remains < 0.5 & buff.jungle_stalker.up",
								["action"] = "prowl",
							}, -- [2]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.tigers_fury.down || energy.deficit >= 60",
								["action"] = "tigers_fury",
							}, -- [4]
							{
								["action"] = "berserking",
						...
						["single_target"] = {
							...
							}, -- [6]
							{
								...
								["list_name"] = "st_finishers",
							}, -- [7]
							{
								["enabled"] = true,
								["action"] = "run_action_list",
								["list_name"] = "st_generators",
							}, -- [8]
						},
						["st_finishers"] = {
							{
						...
						["st_generators"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "azerite.power_of_the_moon.enabled & ! buff.incarnation.up",
								["action"] = "moonfire_cat",
							}, -- [19]
							{
								["enabled"] = true,
				...
				["Balance"] = {
					...
					["lists"] = {
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "equipped.azurethos_singed_plumage & ( cooldown.incarnation.remains > 30 || cooldown.celestial_alignment.remains > 30 )",
								["name"] = "azurethos_singed_plumage",
								["action"] = "azurethos_singed_plumage",
							}, -- [9]
							{
								["enabled"] = true,
								["criteria"] = "equipped.161902 & ( cooldown.incarnation.remains > 30 || cooldown.celestial_alignment.remains > 30 )",
							...
							{
								["enabled"] = true,
								["criteria"] = "azerite.lively_spirit.enabled & ( cooldown.incarnation.up || cooldown.celestial_alignment.remains < 12 ) & ( ( ( raid_event.adds.duration % 15 ) * ( 4 ) < ( raid_event.adds.in % 180 ) ) || ( raid_event.adds.up ) )",
								["action"] = "innervate",
							}, -- [13]
							{
								["enabled"] = true,
								["criteria"] = "astral_power >= 40 & ( ( ( raid_event.adds.duration % 30 ) * ( 4 ) < ( raid_event.adds.in % 180 ) ) || ( raid_event.adds.up ) )",
								["action"] = "incarnation",
							}, -- [14]
							{
								["enabled"] = true,
								["criteria"] = "astral_power >= 40 & ( ! azerite.lively_spirit.enabled || buff.lively_spirit.up ) & ( ( ( raid_event.adds.duration % 15 ) * ( 4 ) < ( raid_event.adds.in % 180 ) ) || ( raid_event.adds.up ) )",
								["action"] = "celestial_alignment",
							}, -- [15]
							{
								["enabled"] = true,
								["criteria"] = "( ( ( raid_event.adds.duration % 8 ) * ( 4 ) < ( raid_event.adds.in % 60 ) ) || ( raid_event.adds.up ) ) & ( ( buff.celestial_alignment.up || buff.incarnation.up ) || ( cooldown.celestial_alignment.remains > 30 || cooldown.incarnation.remains > 30 ) )",
								["action"] = "fury_of_elune",
							}, -- [16]
							{
								["enabled"] = true,
								["criteria"] = "( buff.celestial_alignment.up || buff.incarnation.up ) || ( cooldown.celestial_alignment.remains > 30 || cooldown.incarnation.remains > 30 )",
								["action"] = "force_of_nature",
							}, -- [17]
							{
								["enabled"] = true,
								["criteria"] = "refreshable & ( astral_power.deficit >= 7 & target.time_to_die > 5.4 & ( ! buff.celestial_alignment.up & ! buff.incarnation.up || ! variable.az_streak || ! prev_gcd.1.sunfire ) & ( movement.distance > 0 || raid_event.movement.in > remains || remains <= execute_time * 2 ) )",
								["action"] = "sunfire",
								["cycle_targets"] = 1,
							}, -- [18]
							{
								["enabled"] = true,
								["criteria"] = "refreshable & ( astral_power.deficit >= 7 & target.time_to_die > 6.6 & ( ! buff.celestial_alignment.up & ! buff.incarnation.up || ! variable.az_streak || ! prev_gcd.1.moonfire ) & ( movement.distance > 0 || raid_event.movement.in > remains || remains <= execute_time * 2 ) )",
								["action"] = "moonfire",
								["cycle_targets"] = 1,
							}, -- [19]
							{
								["enabled"] = true,
								["criteria"] = "refreshable & ( astral_power.deficit >= 12 & target.time_to_die > 7.2 & ( ! buff.celestial_alignment.up & ! buff.incarnation.up || ! variable.az_streak || ! prev_gcd.1.stellar_flare ) )",
								["action"] = "stellar_flare",
								["cycle_targets"] = 1,
							}, -- [20]
							{
								["enabled"] = true,
								["criteria"] = "astral_power.deficit >= 16 & ( buff.lunar_empowerment.stack = 3 || ( spell_targets < 3 & astral_power >= 40 & ( buff.lunar_empowerment.stack = 2 & buff.solar_empowerment.stack = 2 ) ) ) & ! ( spell_targets.moonfire >= 2 & variable.az_potm = 3 & active_enemies = 2 )",
								["action"] = "lunar_strike",
							}, -- [21]
							{
								["enabled"] = true,
								["criteria"] = "astral_power.deficit >= 12 & ( buff.solar_empowerment.stack = 3 || ( variable.az_sb > 1 & spell_targets.starfall < 3 & astral_power >= 32 & ! buff.sunblaze.up ) ) & ! ( spell_targets.moonfire >= 2 & active_enemies <= 4 & variable.az_potm = 3 ) || ( variable.az_streak & ( buff.celestial_alignment.up || buff.incarnation.up ) & ! prev_gcd.1.solar_wrath & astral_power.deficit >= 12 )",
								["action"] = "solar_wrath",
							}, -- [22]
							{
								["enabled"] = true,
								["criteria"] = "( spell_targets.starfall < 3 & ( ! buff.starlord.up || buff.starlord.remains >= 4 ) || execute_time * ( astral_power % 40 ) > target.time_to_die ) & ( ! buff.celestial_alignment.up & ! buff.incarnation.up || variable.az_streak < 2 || ! prev_gcd.1.starsurge ) & ( raid_event.movement.in > ( buff.lunar_empowerment.stack * action.lunar_strike.execute_time + buff.solar_empowerment.stack * action.solar_wrath.execute_time ) || ( astral_power + buff.lunar_empowerment.stack * 12 + buff.solar_empowerment.stack * 8 ) >= 96 )",
								["action"] = "starsurge",
							}, -- [23]
							{
								["enabled"] = true,
								["criteria"] = "spell_targets.starfall >= 3 & ( ! buff.starlord.up || buff.starlord.remains >= 4 )",
								["action"] = "starfall",
							}, -- [24]
							{
								["enabled"] = true,
								["criteria"] = "astral_power.deficit > 10 + execute_time % 1.5",
								["action"] = "new_moon",
							}, -- [25]
							{
								["enabled"] = true,
								["criteria"] = "astral_power.deficit > 20 + execute_time % 1.5",
								["action"] = "half_moon",
							}, -- [26]
							{
								["enabled"] = true,
								["criteria"] = "astral_power.deficit > 40 + execute_time % 1.5",
								["action"] = "full_moon",
							}, -- [27]
							{
								["enabled"] = true,
								["criteria"] = "( ( buff.warrior_of_elune.up || buff.lunar_empowerment.up || spell_targets >= 3 & ! buff.solar_empowerment.up ) & ( ! buff.celestial_alignment.up & ! buff.incarnation.up || variable.az_streak < 2 || ! prev_gcd.1.lunar_strike ) || ( variable.az_ds & ! buff.dawning_sun.up ) ) & ! ( spell_targets.moonfire >= 2 & active_enemies <= 4 & ( variable.az_potm = 3 || variable.az_potm = 2 & active_enemies = 2 ) )",
								["action"] = "lunar_strike",
							}, -- [28]
							{
								["enabled"] = true,
								["criteria"] = "( ! buff.celestial_alignment.up & ! buff.incarnation.up || variable.az_streak < 2 || ! prev_gcd.1.solar_wrath ) & ! ( spell_targets.moonfire >= 2 & active_enemies <= 4 & ( variable.az_potm = 3 || variable.az_potm = 2 & active_enemies = 2 ) )",
								["action"] = "solar_wrath",
							}, -- [29]
							{
								["enabled"] = true,
								["criteria"] = "( ! buff.celestial_alignment.up & ! buff.incarnation.up || ! variable.az_streak || ! prev_gcd.1.sunfire ) & ! ( variable.az_potm >= 2 & spell_targets.moonfire >= 2 )",
								["action"] = "sunfire",
							}, -- [30]
							{
								["action"] = "moonfire",
						...
						["precombat"] = {
							...
							{
								["value"] = "azerite.streaking_stars.rank",
								["var_name"] = "az_streak",
								["action"] = "variable",
								["enabled"] = true,
							}, -- [4]
							{
								["value"] = "azerite.dawning_sun.rank",
								["var_name"] = "az_ds",
								["action"] = "variable",
								["enabled"] = true,
							}, -- [5]
							{
								["value"] = "azerite.sunblaze.rank",
								["var_name"] = "az_sb",
								["action"] = "variable",
								["enabled"] = true,
							}, -- [6]
							{
								["enabled"] = true,
								["action"] = "variable",
								["value"] = "azerite.power_of_the_moon.rank",
								["var_name"] = "az_potm",
