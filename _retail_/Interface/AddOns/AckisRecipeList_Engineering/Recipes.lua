...
function module:InitializeRecipes()
	...
	recipe:SetItemFilterType("ENGINEERING_MATERIALS")
	recipe:AddTrainer(1676, 1702, 3290, 3494, 4941, 5174, 5518, 8736, 11017, 11025, 11031, 11037, 16667, 16726, 17222, 17637, 18752, 18775, 19576, 25099, 29513, 29514, 33611, 33634, 45545, 47384, 47396, 47400, 47418, 47419, 47421, 47431, 48619, 49885, 52636, 52651, 55143, 57620, 65043, 85918, 86012, 92194, 93520)
	...
	recipe:SetItemFilterType("ENGINEERING_CREATED_ITEM")
	recipe:AddTrainer(1676, 1702, 3290, 3494, 4941, 5174, 5518, 8736, 11017, 11025, 11031, 11037, 16667, 16726, 17222, 17637, 18752, 18775, 19576, 25099, 33611, 33634, 45545, 49885, 52636, 52651, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_GUN")
	recipe:AddTrainer(1702, 3494, 4941, 5174, 5518, 8736, 11017, 11025, 11031, 11037, 16667, 16726, 17222, 25099, 33611, 33634, 45545, 49885, 52636, 52651, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_MATERIALS")
	recipe:AddTrainer(1676, 1702, 3290, 3494, 4941, 5174, 5518, 8736, 11017, 11025, 11031, 11037, 16667, 16726, 17222, 17637, 18752, 18775, 19576, 25099, 33611, 33634, 45545, 52636, 52651, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_ITEM_ENHANCEMENT")
	recipe:AddTrainer(1702, 4941, 5174, 5518, 8736, 11017, 11025, 11031, 11037, 16667, 16726, 17222, 25099, 33611, 33634, 45545, 52636, 52651, 55143)
	...
	recipe:AddTrainer(1702, 4941, 5174, 5518, 8126, 8736, 11017, 11025, 11031, 11037, 16667, 16726, 17222, 25099, 29513, 33611, 33634, 45545, 52636, 52651, 55143, 86012, 93520)
	...
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddTrainer(1702, 3494, 4941, 5174, 5518, 8736, 11017, 11025, 11031, 11037, 16667, 16726, 17222, 25099, 33611, 33634, 45545, 52636, 52651, 55143)
	...
	recipe:SetSpecialty(20222)
	recipe:SetItemFilterType("ENGINEERING_TRINKET")
	recipe:AddTrainer(1702, 4941, 5174, 5518, 8126, 8736, 8738, 11017, 11025, 11031, 11037, 16667, 16726, 17222, 25099, 29513, 33611, 33634, 45545, 52636, 52651, 55143, 86012, 93520)
	...
	recipe:SetItemFilterType("ENGINEERING_TRINKET")
	recipe:AddTrainer(1702, 4941, 5174, 5518, 7406, 7944, 8736, 11017, 11025, 11031, 11037, 16667, 16726, 17222, 25099, 29514, 33611, 33634, 45545, 52636, 52651, 55143, 85918, 92194)
	...
	recipe:SetItemFilterType("ENGINEERING_MATERIALS")
	recipe:AddTrainer(1702, 3494, 5174, 11031, 17634, 17637, 18752, 18775, 19576, 25099, 33611, 33634, 33677, 55143)
	...
	recipe:SetSpecialty(20222)
	recipe:SetItemFilterType("ENGINEERING_CREATED_ITEM")
	recipe:AddTrainer(1702, 5174, 8126, 8738, 11031, 17634, 25099, 29513, 33611, 33634, 33677, 55143, 86012, 93520)
	...
	recipe:SetSpecialty(20219)
	recipe:SetItemFilterType("ENGINEERING_CREATED_ITEM")
	recipe:AddTrainer(1702, 5174, 7406, 7944, 11031, 17634, 25099, 29514, 33611, 33634, 33677, 55143, 85918, 92194)
	...
	recipe:AddTrainer(1702, 5174, 11031, 17634, 17637, 18752, 18775, 19576, 25099, 33677)
	...
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.HUNTER, F.SHAMAN)
	recipe:AddTrainer(4941, 17634, 17637, 18752, 18775, 19576, 33677)
	...
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.DRUID, F.ROGUE, F.MONK)
	recipe:AddTrainer(5174, 17634, 17637, 18752, 18775, 19576, 33677, 85918)
	...
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.CASTER, F.HEALER, F.MAGE, F.PRIEST, F.WARLOCK)
	recipe:AddTrainer(3494, 5174, 17634, 17637, 18752, 18775, 19576, 33611, 33634, 33677, 55143)
	...
	recipe:AddTrainer(5174, 17634, 17637, 18752, 18775, 19576, 33611, 33634, 33677, 55143)
	...
	recipe:AddTrainer(1702, 3494, 5174, 11031, 17634, 17637, 24868, 25099, 33611, 33634, 33677, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_MATERIALS")
	recipe:AddTrainer(1702, 3494, 5174, 11031, 17637, 25099, 25277, 26907, 26955, 26991, 28697, 33586, 33611, 33634, 55143)
	...
	recipe:AddTrainer(3494, 5174, 17637, 25277, 26907, 26955, 26991, 28697, 33586, 33611, 33634, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_CREATED_ITEM")
	recipe:AddTrainer(4941, 5174, 11031, 25099, 25277, 26907, 26955, 26991, 28697, 33586, 33611, 33634, 55143)
	...
	recipe:SetSpecialty(20219)
	recipe:SetItemFilterType("ENGINEERING_TOY")
	recipe:AddTrainer(1702, 5174, 11031, 25099, 25277, 26907, 26955, 26991, 28697, 29514, 33586, 33611, 33634, 55143, 85918, 92194)
	...
	recipe:SetSpecialty(20222)
	recipe:SetItemFilterType("ENGINEERING_CREATED_ITEM")
	recipe:AddTrainer(1702, 5174, 11031, 25099, 25277, 26907, 26955, 26991, 28697, 29513, 33586, 33611, 33634, 55143, 86012, 93520)
	...
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.DRUID, F.ROGUE, F.MONK)
	recipe:AddTrainer(1702, 5174, 25277, 26907, 26955, 26991, 28697, 33586, 55143)
	...
	recipe:AddTrainer(1702, 5174, 11031, 25099, 25277, 26907, 26955, 26991, 28697, 33586, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_TRINKET")
	recipe:AddFilters(F.CASTER, F.HEALER)
	recipe:AddTrainer(1676, 1702, 3290, 3494, 4941, 5174, 5518, 8736, 11017, 11025, 11031, 11037, 16667, 16726, 17222, 17637, 25099, 33611, 33634, 45545, 52636, 52651, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.CASTER, F.HEALER, F.MAGE, F.PRIEST, F.WARLOCK)
	recipe:AddTrainer(3494, 4941, 5174, 5518, 8736, 11017, 11025, 11037, 16667, 16726, 17222, 17637, 33611, 33634, 45545, 52636, 52651, 55143)
	...
	recipe:SetItemFilterType("ENGINEERING_MATERIALS")
	recipe:AddTrainer(1702, 3494, 4941, 5174, 5518, 8736, 11017, 11025, 11031, 11037, 16667, 16726, 17222, 17637, 25099, 33611, 33634, 45545, 52636, 52651, 55143)
	...
	recipe:SetSpecialty(20222)
	recipe:SetItemFilterType("ENGINEERING_PET")
	recipe:AddTrainer(1702, 4941, 5174, 5518, 8736, 11017, 11025, 11031, 11037, 16667, 16726, 17222, 25099, 29513, 33611, 33634, 45545, 52636, 52651, 55143, 86012, 93520)
	...
	recipe:SetSpecialty(20219)
	recipe:SetItemFilterType("ENGINEERING_PET")
	recipe:AddTrainer(1702, 4941, 5174, 5518, 7944, 8736, 11017, 11025, 11031, 11037, 16667, 16726, 17222, 25099, 29514, 33611, 33634, 45545, 52636, 52651, 55143, 85918, 92194)
	...
	recipe:SetSkillLevels(25, 25, 35, 40, 45)
	recipe:SetItemFilterType("ENGINEERING_ITEM_ENHANCEMENT")
	recipe:AddTrainer(4941, 5174, 11031, 25099, 33611, 33634, 55143, 64924)
	...
	recipe:SetItemFilterType("ENGINEERING_HEAD")
	recipe:AddFilters(F.CASTER, F.HEALER, F.MAGE, F.PRIEST, F.WARLOCK)
	recipe:AddTrainer(5174, 33611, 33634, 55143, 64924)
	...
	recipe:SetSpecialty(20222)
	recipe:SetItemFilterType("ENGINEERING_MOUNT")
	recipe:AddTrainer(4941, 5174, 11031, 25099, 29513, 33611, 33634, 55143, 64924, 86012, 93520)
	...
	recipe:SetSpecialty(20219)
	recipe:SetItemFilterType("ENGINEERING_MOUNT")
	recipe:AddTrainer(4941, 5174, 11031, 25099, 29514, 33611, 33634, 55143, 64924, 85918, 92194)
	...
	recipe = AddRecipe(169076, V.WOD, Q.COMMON)
	recipe:SetSkillLevels(1, 1, 700, 702, 705)
	recipe:SetRecipeItem(118491, "BIND_ON_PICKUP")
	...
	recipe = AddRecipe(177363, V.WOD, Q.COMMON)
	recipe:SetSkillLevels(1, 1, 700, 702, 705)
	recipe:SetRecipeItem(120268, "BIND_ON_PICKUP")
	recipe:SetCraftedItem(119822, "BIND_ON_EQUIP")
	recipe:SetItemFilterType("ENGINEERING_ITEM_ENHANCEMENT")
	recipe:AddVendor(77365, 79826, 87065, 87552)
	...
	recipe:SetItemFilterType("ENGINEERING_ONE_HAND_MACE")
	recipe:AddTrainer(131840, 136059, 153817, 154321)
