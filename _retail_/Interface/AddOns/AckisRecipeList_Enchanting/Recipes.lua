...
function module:InitializeRecipes()
	...
	recipe:AddTrainer(1317, 3011, 3345, 4213, 4616, 5157, 5695, 7949, 11072, 11073, 11074, 16160, 16633, 16725, 18753, 18773, 19251, 19252, 33610, 33633, 47384, 47396, 47400, 47418, 47419, 47421, 47431, 48619, 49885, 53410, 57620, 65043, 65127, 85914, 86027, 93531, 98017)
	...
	recipe:AddTrainer(1317, 3011, 3345, 4213, 4616, 5157, 5695, 7949, 11072, 11073, 11074, 16160, 16633, 16725, 18753, 18773, 19251, 19252, 33610, 33633, 49885, 53410, 65127, 98017)
	...
	recipe:SetItemFilterType("ENCHANTING_SHIELD")
	recipe:AddTrainer(1317, 3011, 3345, 4213, 4616, 5157, 5695, 7949, 11072, 11073, 11074, 16160, 16633, 16725, 18753, 18773, 19251, 19252, 33610, 33633, 53410, 65127)
	...
	recipe:SetItemFilterType("ENCHANTING_BRACER")
	recipe:AddFilters(F.TANK)
	recipe:AddTrainer(1317, 3011, 3345, 4213, 4616, 5157, 5695, 16633, 16725, 18753, 18773, 33610, 53410, 65127)
	...
	recipe:SetItemFilterType("ENCHANTING_BRACER")
	recipe:AddFilters(F.DPS)
	recipe:AddTrainer(4213, 18753, 18773, 19251, 19252, 19540, 33610, 33633, 33676, 65127)
	...
	recipe:SetItemFilterType("ENCHANTING_CHEST")
	recipe:AddFilters(F.CASTER, F.HEALER)
	recipe:AddTrainer(4213, 18753, 18773, 19251, 19252, 26906, 26954, 26980, 26990, 28693, 33583, 33610, 33633, 65127)
	...
	recipe:SetItemFilterType("ENCHANTING_MISC")
	recipe:AddTrainer(4213, 18753, 18773, 26906, 26954, 26980, 26990, 28693, 33583, 33610, 33633, 65127)
	...
	recipe:SetSkillLevels(1, 1, 11, 16, 21)
	recipe:SetItemFilterType("ENCHANTING_GLOVES")
	recipe:AddTrainer(1317, 3011, 3345, 4213, 4616, 5157, 5695, 16633, 16725, 18753, 18773, 19251, 19252, 33610, 33633, 53410, 65127)
	...
	recipe:SetItemFilterType("ENCHANTING_BRACER")
	recipe:AddTrainer(4213, 18753, 18773, 19251, 19252, 33610, 33633, 65127)
	...
	recipe:AddTrainer(1317, 3011, 3345, 4213, 4616, 5157, 5695, 7949, 11072, 11073, 11074, 16160, 16633, 16725, 18753, 18773, 19251, 19252, 33610, 33633, 47419, 47421, 49885, 53410, 57620, 65043, 65127)
	...
	recipe:SetItemFilterType("ENCHANTING_ILLUSION")
	recipe:AddTrainer(4213, 7949, 11072, 11073, 11074, 16160, 18753, 18773, 19251, 19252, 19540, 33610, 33633, 33676, 47419, 47421, 49885, 57620, 65043, 65127)
	...
	recipe:SetItemFilterType("ENCHANTING_ILLUSION")
	recipe:AddTrainer(4213, 7949, 11072, 11073, 11074, 16160, 18753, 18773, 19251, 19252, 26906, 26954, 26980, 26990, 28693, 33583, 33610, 33633, 47419, 47421, 49885, 57620, 65043, 65127)
	...
	recipe:SetItemFilterType("ENCHANTING_ILLUSION")
	recipe:AddTrainer(4213, 7949, 11072, 11073, 11074, 16160, 18753, 18773, 19251, 19252, 33610, 33633, 47419, 47421, 49885, 57620, 65043, 65127)
	...
	recipe:SetCraftedItem(168441, "BIND_ON_EQUIP")
	recipe:SetItemFilterType("ENCHANTING_RING")
	recipe:AddRepVendor(FAC.ANKOAN, REP.REVERED, 154140)
	recipe:AddRepVendor(FAC.UNSHACKLED, REP.REVERED, 153512)
