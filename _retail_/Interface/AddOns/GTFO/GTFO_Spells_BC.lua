...
GTFO.SpellID["30421"] = {
  --desc = "Perseverance (Netherspite - Karazhan)";
  sound = 1;
...
GTFO.SpellID["30423"] = {
  --desc = "Dominance (Netherspite - Karazhan)";
  sound = 1;
  applicationOnly = true;
  minimumStacks = 30;
  trivialLevel = 80;
...
GTFO.SpellID["30860"] = {
  --desc = "Hellfire Effect (Prince Malchezaar - Karazhan)";
  sound = 1;
};
...
GTFO.SpellID["38977"] = {
  --desc = "Spore Quake Effect (Underbog Colossus)";
  sound = 1;
  tankSound = 2;
};

GTFO.SpellID["38653"] = {
  --desc = "Spore Cloud (Rancid Mushroom)";
  applicationOnly = true;
  sound = 1;
};
