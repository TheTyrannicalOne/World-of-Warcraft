...
local rareDB = {
    ...
    [1527] = {
        ...
        rares = {
            ...
            [154604] = { name = L["lord_ajqirai"], npcid = 154604, questId = { 56340 }, type = TYPE_RARE, faction = FACTION_ALL, coord = { 34741885 }, bothphases = true, assault = assaultType.aqir, cave = { 36852093 }, note = "Inside cave", loot = { { droptype = DROP_PET, itemID = 174475, petID = 161997, speciesID = 2847, isKnown = false } } }, -- Lord Aj'qirai | Invasion Type: Aqir
            [162140] = { name = L["skikxtraz"], npcid = 162140, questId = { 58697 }, type = TYPE_RARE, faction = FACTION_ALL, coord = { 21236105 }, bothphases = true, assault = assaultType.aqir, loot = { { droptype = DROP_PET, itemID = 174476, petID = 162004, speciesID = 2848, isKnown = false } } }, -- Skikx'traz | Invasion Type: Aqir
            -- Toy Drops:
            ...
            [158636] = { name = L["the_grand_executor"], npcid = 158636, questId = { 57688 }, type = TYPE_RARE, faction = FACTION_ALL, coord = { 49358229 }, bothphases = true, assault = assaultType.blackEmpire, loot = { { droptype = DROP_TOY, itemID = 169303, isKnown = false } } }, -- The Grand Executor | Invasion Type: Black Empire
            [157473] = { name = L["yiphrim_the_will_ravager"], npcid = 157473, questId = { 57438 }, type = TYPE_RARE, faction = FACTION_ALL, coord = { 0 }, bothphases = true, assault = assaultType.blackEmpire, loot = { { droptype = DROP_TOY, itemID = 174874, isKnown = false } } }, -- Yiphrim the Will Ravager | Invasion Type: Black Empire !Coords
            -- Item Only:
            -- Gear Only:
            -- Quest Drops:
            -- Unknown:
            ...
            [158594] = { name = L["doomsayer_vathiris"], npcid = 158594, questId = { 57672 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 49403819 }, bothphases = true, assault = assaultType.blackEmpire, loot = {  } }, -- Doomsayer Vathiris
            [158491] = { name = L["falconer_amenophis"], npcid = 158491, questId = { 57662 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 44247856 }, bothphases = true, assault = assaultType.blackEmpire, loot = {  } }, -- Falconer Amenophis
            [157120] = { name = L["fangtaker_orsa"], npcid = 157120, questId = { 57258 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 75076812 }, bothphases = true, assault = assaultType.amathet, loot = {  } }, -- Fangtaker Orsa
            [158597] = { name = L["high_executor_yothrim"], npcid = 158597, questId = { 57675 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 54764309 }, bothphases = true, assault = assaultType.blackEmpire, loot = {  } }, -- High Executor Yothrim
            [158528] = { name = L["high_guard_reshef"], npcid = 158528, questId = { 57664 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 53687933 }, bothphases = true, assault = assaultType.blackEmpire, loot = {  } }, -- High Guard Reshef
            ...
            [162173] = { name = L["rkrox_the_runt"], npcid = 162173, questId = { 58864 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 28901765 }, bothphases = true, assault = assaultType.aqir, loot = {  } }, -- R'krox the Runt
            [152040] = { name = L["scoutmaster_moswen"], npcid = 152040, questId = { 55518 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 69924214 }, bothphases = true, assault = assaultType.amathet, loot = {  } }, -- Scoutmaster Moswen
            [151948] = { name = L["senbu_the_pridefather"], npcid = 151948, questId = { 55496 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 74136436 }, bothphases = true, assault = assaultType.amathet, loot = {  } }, -- Senbu the Pridefather
            ...
            [162170] = { name = L["warcaster_xeshro"], npcid = 162170, questId = { 58702 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 33502618 }, bothphases = true, assault = assaultType.aqir, loot = {  } }, -- Warcaster Xeshro
    ...
    [1530] = {
        ...
        rares = {
            -- Bosses:
            -- Mount Drops:
            [157160] = { name = L["houndlord_ren"], npcid = 157160, questId = { 57345 }, type = TYPE_ELITE, faction = FACTION_ALL, coord = { 09823288 }, bothphases = true, assault = assaultType.mogu, loot = { { droptype = DROP_MOUNT, itemID = 174841, mountID = 1327, isKnown = false } } }, -- Houndlord Ren | Invasion Type: Mogu
            [157153] = { name = L["ha_li"], npcid = 157153, questId = { 57344 }, type = TYPE_ELITE, faction = FACTION_ALL, coord = { 29513800 }, bothphases = true, assault = assaultType.mogu, loot = { { droptype = DROP_MOUNT, itemID = 173887, mountID = 1297, isKnown = false } } }, -- Ha-Li | Invasion Type: Mogu
            [163042] = { name = L["ivory_cloud_serpent"], npcid = 163042, questId = { 57349 }, type = TYPE_ELITE, faction = FACTION_ALL, coord = { 42205630 }, bothphases = true, assault = assaultType.mogu, note = "NPC can be activated using a 'Zan-Tien Lasso', dropped by Dokani Bloodshapers.", loot = { { droptype = DROP_MOUNT, itemID = 174752, mountID = 1311, isKnown = false } } }, -- Ivory Cloud Serpent | Unlock lika Alani!!!
            ...
            -- Pet Drops:
            [154495] = { name = L["will_of_nzoth"], npcid = 154495, questId = { 56303 }, type = TYPE_RARE, faction = FACTION_ALL, coord = { 54266272 }, bothphases = true, assault = assaultType.blackEmpire, loot = { { droptype = DROP_PET, itemID = 174474, petID = 161992, speciesID = 2846, isKnown = false }, { droptype = DROP_TOY, itemID = 175140, note = "Toy is crafted with an 'All-Seeing Right Eye' and an 'All-Seeing Left Eye'.", isKnown = false } } }, -- Will of N'Zoth | Invasion Type: Black Empire
            [157176] = { name = L["the_forgotten"], npcid = 157176, questId = { 57342 }, type = TYPE_RARE, faction = FACTION_ALL, coord = { 51884116 }, bothphases = true, assault = assaultType.blackEmpire, loot = { { droptype = DROP_PET, itemID = 174473, petID = 161954, speciesID = 2845, isKnown = false } } }, -- The Forgotten | Invasion Type: Black Empire
            -- Toy Drops:
            [155958] = { name = L["tashara"], npcid = 155958, questId = { 58507 }, type = TYPE_RARE, faction = FACTION_ALL, coord = { 30842398 }, bothphases = true, assault = assaultType.mogu, loot = { { droptype = DROP_TOY, itemID = 174873, isKnown = false } } }, -- Tashara | Invasion Type: Black Empire
            -- Item Only:
            [157287] = { name = L["dokani_obliterator"], npcid = 157287, questId = { 57349 }, type = TYPE_RARE, faction = FACTION_ALL, coord = { 41205630 }, bothphases = true, assault = assaultType.mogu, loot = { { droptype = DROP_ITEM, itemID = 174927, isKnown = false } } }, -- Dokani Obliterator | Invasion Type: Mogu
            -- Gear Only:
            -- Quest Drops:
            -- Unknown:
            ...
            [154559] = { name = L["deeplord_zrihj"], npcid = 154559, questId = { 56323 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 66996658 }, bothphases = true, assault = assaultType.blackEmpire, loot = {  } }, -- Deeplord Zrihj
            [154600] = { name = L["teng_the_awakened"], npcid = 154600, questId = { 56332 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 47516521 }, bothphases = true, assault = assaultType.mogu, loot = {  } }, -- Teng the Awakened
            [156083] = { name = L["sanguifang"], npcid = 156083, questId = { 56954 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 46185713 }, bothphases = true, assault = assaultType.mogu, loot = {  } }, -- Sanguifang
            [157162] = { name = L["rei_lun"], npcid = 157162, questId = { 57346 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 21901234 }, bothphases = true, assault = assaultType.mogu, loot = {  } }, -- Rei Lun
            [157171] = { name = L["heixi_the_stonelord"], npcid = 157171, questId = { 57347 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 28224048 }, bothphases = true, assault = assaultType.mogu, loot = {  } }, -- Heixi the Stonelord
            [157183] = { name = L["coagulated_anima"], npcid = 157183, questId = { 58296 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 16766672 }, bothphases = true, assault = assaultType.mogu, loot = {  } }, -- Coagulated Anima
            [157266] = { name = L["kilxl_the_gaping_maw"], npcid = 157266, questId = { 57341 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 45005800 }, bothphases = true, assault = assaultType.blackEmpire, loot = {  } }, -- Kilxl the Gaping Maw
            [157267] = { name = L["escaped_mutation"], npcid = 157267, questId = { 57343 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 46144226 }, bothphases = true, assault = assaultType.blackEmpire, loot = {  } }, -- Escaped Mutation
            [157279] = { name = L["stormhowl"], npcid = 157279, questId = { 57348 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 27277432 }, bothphases = true, assault = assaultType.mogu, loot = {  } }, -- Stormhowl
            [157290] = { name = L["jade_watcher"], npcid = 157290, questId = { 57350 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 26821109 }, bothphases = true, note = "In a cave", assault = assaultType.mogu, loot = {  } }, -- Jade Watcher
            [157291] = { name = L["spymaster_hulach"], npcid = 157291, questId = { 57351 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 17863748 }, bothphases = true, assault = assaultType.mogu, loot = {  } }, -- Spymaster Hul'ach
            [157443] = { name = L["xiln_the_mountain"], npcid = 157443, questId = { 57358 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 53804886 }, bothphases = true, assault = assaultType.mogu, loot = {  } }, -- Xiln the Mountain
            [157468] = { name = L["tisiphon"], npcid = 157468, questId = { 57364 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 10456907 }, bothphases = true, assault = { assaultType.mantid, assaultType.mogu }, loot = {  } }, -- Tisiphon
            [160810] = { name = L["harbinger_ilkoxik"], npcid = 160810, questId = { 58299 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 29065767 }, bothphases = true, assault = assaultType.mantid, loot = {  } }, -- Harbinger Il'koxik
            [160825] = { name = L["amber_shaper_eshri"], npcid = 160825, questId = { 58300 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 19997468 }, bothphases = true, assault = assaultType.mantid, loot = {  } }, -- Amber-Shaper Esh'ri
            [160826] = { name = L["hive_guard_nazruzek"], npcid = 160826, questId = { 58301 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 21276263 }, bothphases = true, assault = assaultType.mantid, loot = {  } }, -- Hive-Guard Naz'ruzek
            [160867] = { name = L["kzitkovok"], npcid = 160867, questId = { 58302 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 27893897 }, bothphases = true, assault = assaultType.mantid, loot = {  } }, -- Kzit'kovok
            [160868] = { name = L["harrier_nirverash"], npcid = 160868, questId = { 58303 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 12845130 }, bothphases = true, assault = assaultType.mantid, loot = {  } }, -- Harrier Nir'verash
            [160872] = { name = L["destroyer_kroxtazar"], npcid = 160872, questId = { 58304 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 15953668 }, bothphases = true, assault = assaultType.mantid, loot = {  } }, -- Destroyer Krox'tazar
            [160874] = { name = L["drone_keeper_akthet"], npcid = 160874, questId = { 58305 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 12574106 }, bothphases = true, assault = assaultType.mantid, loot = {  } }, -- Drone Keeper Ak'thet
            [160876] = { name = L["enraged_amber_elemental"], npcid = 160876, questId = { 58306 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 11464062 }, bothphases = true, assault = assaultType.mantid, loot = {  } }, -- Enraged Amber Elemental
            [160878] = { name = L["buhgzaki_the_blasphemous"], npcid = 160878, questId = { 58307 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 6657066 }, bothphases = true, assault = assaultType.mantid, loot = {  } }, -- Buh'gzaki the Blasphemous
            [160893] = { name = L["captain_vorlek"], npcid = 160893, questId = { 58308 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 5986420 }, bothphases = true, assault = assaultType.mantid, loot = {  } }, -- Captain Vor'lek
            [160920] = { name = L["kaltik_the_blight"], npcid = 160920, questId = { 58310 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 17680998 }, bothphases = true, assault = assaultType.mantid, loot = {  } }, -- Kal'tik the Blight
...
local function getCurrentAssault(mapid)
    ...
    if textures and textures[1].fileDataIDs[1] == 3165083 then
        ...
        return assaultType.aqir -- Uldum left
    elseif textures and textures[1].fileDataIDs[1] == 3165092 then
        --print('Uldum assault: blackEmpire')
        return assaultType.blackEmpire -- Uldum middle
    elseif textures and textures[1].fileDataIDs[1] == 3165098 then
        --print('Uldum assault: amathet')
        return assaultType.amathet -- Uldum right
    elseif textures and textures[1].fileDataIDs[1] == 3155826 then
        --print('Vale assault: MAN')
        return assaultType.mantid -- Vale left
    elseif textures and textures[1].fileDataIDs[1] == 3155832 then
        --print('Vale assault: MOG')
        return assaultType.mogu -- Vale middle
    elseif textures and textures[1].fileDataIDs[1] == 3155841 then
        --print('Vale assault: EMP')
        return assaultType.blackEmpire -- Vale right
    end
...
local function checkAssault(mapid, npcid)
    if rareDB[mapid] ~= nil and rareDB[mapid].rares[npcid] ~= nil and rareDB[mapid].rares[npcid].assault ~= nil then
        ...
        for  i = 1, #assault, 1 do
            if i > #assault then
                --print("checkAssault(..mapid.., ..npcid..) Asault not active for: " .. rareDB[mapid].rares[npcid].name)
                return false
            end
            if assault[i] == rareDB[mapid].currentAssault or assault[i] == assaultType.unknown or assault[i] == assaultType.all then
                --print("checkAssault(..mapid.., ..npcid..) " .. rareDB[mapid].rares[npcid].name .. " Active!!!!")
                return true
            end
        end
        return false
...
local function showRare(mapid, npcid, mode)
    if isNPCPlayerFaction(mapid, npcid) then
        if rareDB[mapid].zoneType == DB_ZONE_TYPE_ASSAULT and WarfrontRareTracker.db.profile.masterfilter.ignoreAssault == false and rareDB[mapid].rares[npcid].assault ~= nil then
            if checkAssault(mapid, npcid) == false then
                return false
            end
        end
