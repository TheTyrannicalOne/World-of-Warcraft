...
local rareDB = {
    ...
    [1527] = { -- Old Uldum: 249
        ...
        rares = {
            -- Bosses:
            -- Mount Drops:
            [162147] = { name = L["corpse_eater"], npcid = 162147, questId = { 58696 }, type = TYPE_ELITE, faction = FACTION_ALL, coord = { 30854971 }, bothphases = true, assault = assaultType.aqir, loot = { { droptype = DROP_MOUNT, itemID = 174769, mountID = 1319, isKnown = false } } }, -- Corpse Eater | Invasion Type: Aqir
            ...
            -- Toy Drops:
            [158633] = { name = L["gaze_of_nzoth"], npcid = 158633, questId = { 57680 }, type = TYPE_RARE, faction = FACTION_ALL, coord = { 55005300 }, bothphases = true, assault = assaultType.blackEmpire, loot = { { droptype = DROP_TOY, itemID = 175140, note = "Toy is crafted with an 'All-Seeing Right Eye' and an 'All-Seeing Left Eye'.", isKnown = false } } }, -- Gaze of N'Zoth | Invasion Type: Black Empire
            ...
            [152757] = { name = L["atekhramun"], npcid = 152757, questId = { 55710 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 65035129 }, bothphases = true, assault = assaultType.amathet, note = "To spawn, stomp on the mini scorpids around the crack on the ground.", loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Atekhramun
            [162171] = { name = L["captain_dunewalker"], npcid = 162171, questId = { 58699 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 45565782 }, bothphases = true, assault = assaultType.aqir, note = "Located at the inner level of the Obelisk of the Sun.", loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Captain Dunewalker
            [158594] = { name = L["doomsayer_vathiris"], npcid = 158594, questId = { 57672 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 49403819 }, bothphases = true, assault = assaultType.blackEmpire, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Doomsayer Vathiris
            ...
            [157157] = { name = L["muminah_the_incandescent"], npcid = 157157, questId = { 57277 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 67301947 }, bothphases = true, assault = assaultType.amathet, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Muminah the Incandescent
            [152677] = { name = L["nebet_the_ascended"], npcid = 152677, questId = { 55684 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 61982567 }, bothphases = true, assault = assaultType.amathet, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Nebet the Ascended
            [162196] = { name = L["obsidian_annihilator"], npcid = 162196, questId = { 58681 }, type = TYPE_ELITE, faction = FACTION_ALL, coord = { 35061729 }, bothphases = true, assault = assaultType.all, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Obsidian Annihilator
            [162142] = { name = L["qho"], npcid = 162142, questId = { 58693 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 37826028 }, bothphases = true, assault = assaultType.aqir, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Qho
            [156299] = { name = L["rkhuzj_the_unfathomable"], npcid = 156299, questId = { 57430 }, type = TYPE_ELITE, faction = FACTION_ALL, coord = { 57957664 }, bothphases = true, assault = { assaultType.blackEmpire, assaultType.aqir }, note ="Patrols around the Virnaal river path.", loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- R'khuzj The Unfathomable
            [162173] = { name = L["rkrox_the_runt"], npcid = 162173, questId = { 58864 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 28901765 }, bothphases = true, assault = assaultType.aqir, note = "", loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- R'krox the Runt
            [152040] = { name = L["scoutmaster_moswen"], npcid = 152040, questId = { 55518 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 69924214 }, bothphases = true, assault = assaultType.amathet, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Scoutmaster Moswen
            [151948] = { name = L["senbu_the_pridefather"], npcid = 151948, questId = { 55496 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 74136436 }, bothphases = true, assault = assaultType.amathet, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Senbu the Pridefather
            [161033] = { name = L["shadowmaw"], npcid = 161033, questId = { 58333 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 52053798 }, bothphases = true, assault = assaultType.blackEmpire, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Shadowmaw
            [156654] = { name = L["sholthoss_the_doomspeaker"], npcid = 156654, questId = { 57432 }, type = TYPE_ELITE, faction = FACTION_ALL, coord = { 58548282 }, bothphases = true, assault = assaultType.blackEmpire, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Shol'thoss the Doomspeaker
            [160532] = { name = L["shoth_the_darkened"], npcid = 160532, questId = { 58169 }, type = TYPE_ELITE, faction = FACTION_ALL, coord = { 60917478 }, bothphases = true, assault = { assaultType.blackEmpire, assaultType.aqir }, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Shoth the Darkened
            [162372] = { name = L["spirit_of_cyrus_the_black"], npcid = 162372, questId = { 58715 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 66687074 }, bothphases = true, assault = { assaultType.amathet, assaultType.aqir }, note = "", loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Spirit of Cyrus the Black
            [151878] = { name = L["sun_king_nahkotep"], npcid = 151878, questId = { 58613 }, type = TYPE_ELITE, faction = FACTION_ALL, coord = { 79016393 }, bothphases = true, assault = assaultType.all, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Sun King Nahkotep
            [151897] = { name = L["sun_priestess_nubitt"], npcid = 151897, questId = { 55479 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 84595708 }, bothphases = true, assault = assaultType.amathet, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Sun Priestess Nubitt
            [151609] = { name = L["sun_prophet_epaphos"], npcid = 151609, questId = { 55353 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 73327463 }, bothphases = true, assault = assaultType.amathet, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Sun Prophet Epaphos
            [152657] = { name = L["sun_prophet_epaphos"], npcid = 152657, questId = { 55682 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 67073413 }, bothphases = true, assault = assaultType.amathet, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Tat the Bonechewer
            [162170] = { name = L["warcaster_xeshro"], npcid = 162170, questId = { 58702 }, type = TYPE_ELITE, faction = FACTION_ALL, coord = { 33502618 }, bothphases = true, assault = assaultType.aqir, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Warcaster Xeshro
    ...
    [1530] = {
        ...
        rares = {
            -- Bosses:
            -- Mount Drops:
            [157160] = { name = L["houndlord_ren"], npcid = 157160, questId = { 57345 }, type = TYPE_ELITE, faction = FACTION_ALL, coord = { 12592788 }, bothphases = true, assault = assaultType.mogu, note = "Patrols around the Autumnshade Ridge area.", loot = { { droptype = DROP_MOUNT, itemID = 174841, mountID = 1327, isKnown = false } } }, -- Houndlord Ren
            [157153] = { name = L["ha_li"], npcid = 157153, questId = { 57344 }, type = TYPE_ELITE, faction = FACTION_ALL, coord = { 29513800 }, bothphases = true, assault = assaultType.mogu, note = "Flies around the mountain surrounding the Ruins of Guo-Lai.", loot = { { droptype = DROP_MOUNT, itemID = 173887, mountID = 1297, isKnown = false } } }, -- Ha-Li
            [163042] = { name = L["ivory_cloud_serpent"], npcid = 163042, questId = { 57349 }, type = TYPE_ELITE, faction = FACTION_ALL, coord = { 42205630 }, bothphases = true, assault = assaultType.mogu, note = "NPC can be activated using a 'Zan-Tien Lasso', dropped by Dokani Bloodshapers.", loot = { { droptype = DROP_MOUNT, itemID = 174752, mountID = 1311, isKnown = false } } }, -- Ivory Cloud Serpent
            [157466] = { name = L["anh_de_the_loyal"], npcid = 157466, questId = { 57363 }, type = TYPE_ELITE, faction = FACTION_ALL, coord = { 34136858 }, bothphases = true, assault = assaultType.mogu, loot = { { droptype = DROP_MOUNT, itemID = 174840, mountID = 1328, isKnown = false } } }, -- Anh-De the Loyal
            -- Pet Drops:
            [154495] = { name = L["will_of_nzoth"], npcid = 154495, questId = { 56303 }, type = TYPE_ELITE, faction = FACTION_ALL, coord = { 54266272 }, bothphases = true, assault = assaultType.blackEmpire, loot = { { droptype = DROP_PET, itemID = 174474, petID = 161992, speciesID = 2846, isKnown = false }, { droptype = DROP_TOY, itemID = 175140, note = "Toy is crafted with an 'All-Seeing Right Eye' and an 'All-Seeing Left Eye'.", isKnown = false } } }, -- Will of N'Zoth
            [157176] = { name = L["the_forgotten"], npcid = 157176, questId = { 57342 }, type = TYPE_RARE, faction = FACTION_ALL, coord = { 51884116 }, bothphases = true, assault = assaultType.blackEmpire, note = "Spawns on the platforms floating atop the Golden Pagoda.", loot = { { droptype = DROP_PET, itemID = 174473, petID = 161954, speciesID = 2845, isKnown = false } } }, -- The Forgotten
            -- Toy Drops:
            ...
            -- Gear Only:
            [154106] = { name = L["quid"], npcid = 154106, questId = { 56094 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 90164597 }, bothphases = true, assault = assaultType.blackEmpire, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Quid
            [154332] = { name = L["voidtender_malketh"], npcid = 154332, questId = { 56183 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 67082964 }, bothphases = true, assault = assaultType.blackEmpire, note = "Spawns inside the Pools of Power area, but can be seen from above ground.", loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Voidtender Malketh
            [154447] = { name = L["brother_meller"], npcid = 154447, questId = { 56237 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 56854136 }, bothphases = true, assault = assaultType.blackEmpire, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Brother Meller
            [154467] = { name = L["chief_mek_mek"], npcid = 154467, questId = { 56255 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 81086542 }, bothphases = true, assault = assaultType.blackEmpire, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Chief Mek-mek
            [154490] = { name = L["rijzx_the_devourer"], npcid = 154490, questId = { 56302 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 64405166 }, bothphases = true, assault = assaultType.blackEmpire, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Rijz'x the Devourer
            [154559] = { name = L["deeplord_zrihj"], npcid = 154559, questId = { 56323 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 66996658 }, bothphases = true, assault = assaultType.blackEmpire, note = "Located inside the Deep Blossom Mine.", loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Deeplord Zrihj
            [154600] = { name = L["teng_the_awakened"], npcid = 154600, questId = { 56332 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 47516521 }, bothphases = true, assault = assaultType.mogu, note = "Spawns inside the cave in Tu-Shen Burial Grounds.", loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Teng the Awakened
            [157171] = { name = L["heixi_the_stonelord"], npcid = 157171, questId = { 57347 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 28224048 }, bothphases = true, assault = assaultType.mogu, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Heixi the Stonelord
            [157266] = { name = L["kilxl_the_gaping_maw"], npcid = 157266, questId = { 57341 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 45905850 }, bothphases = true, assault = assaultType.blackEmpire, note = "Flies around the Tu-Shen Burial Ground.", loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Kilxl the Gaping Maw
            [157267] = { name = L["escaped_mutation"], npcid = 157267, questId = { 57343 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 46144226 }, bothphases = true, assault = assaultType.blackEmpire, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Escaped Mutation
            [157279] = { name = L["stormhowl"], npcid = 157279, questId = { 57348 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 27277432 }, bothphases = true, assault = assaultType.mogu, note = "Patrols around the target area.", loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Stormhowl
            [157290] = { name = L["jade_watcher"], npcid = 157290, questId = { 57350 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 26821109 }, bothphases = true, note = "Inside a cave.", assault = assaultType.mogu, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Jade Watcher
            [157291] = { name = L["spymaster_hulach"], npcid = 157291, questId = { 57351 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 17863748 }, bothphases = true, assault = assaultType.mogu, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Spymaster Hul'ach
            [157443] = { name = L["xiln_the_mountain"], npcid = 157443, questId = { 57358 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 53804886 }, bothphases = true, assault = assaultType.mogu, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Xiln the Mountain
            [157468] = { name = L["tisiphon"], npcid = 157468, questId = { 57364 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 10456907 }, bothphases = true, assault = assaultType.all, note = "To spawn it, click on the fishing rod next to the body of water.", loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Tisiphon
            [160810] = { name = L["harbinger_ilkoxik"], npcid = 160810, questId = { 58299 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 29065767 }, bothphases = true, assault = assaultType.mantid, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Harbinger Il'koxik
            [160825] = { name = L["amber_shaper_eshri"], npcid = 160825, questId = { 58300 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 19997468 }, bothphases = true, assault = assaultType.mantid, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Amber-Shaper Esh'ri
            [160826] = { name = L["hive_guard_nazruzek"], npcid = 160826, questId = { 58301 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 21276263 }, bothphases = true, assault = assaultType.mantid, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Hive-Guard Naz'ruzek
            [160867] = { name = L["kzitkovok"], npcid = 160867, questId = { 58302 }, type = TYPE_ELITE, faction = FACTION_ALL, coord = { 27893897 }, bothphases = true, assault = assaultType.mantid, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Kzit'kovok
            [160868] = { name = L["harrier_nirverash"], npcid = 160868, questId = { 58303 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 12845130 }, bothphases = true, assault = assaultType.mantid, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Harrier Nir'verash
            [160872] = { name = L["destroyer_kroxtazar"], npcid = 160872, questId = { 58304 }, type = TYPE_ELITE, faction = FACTION_ALL, coord = { 15953668 }, bothphases = true, assault = assaultType.mantid, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Destroyer Krox'tazar
            [160874] = { name = L["drone_keeper_akthet"], npcid = 160874, questId = { 58305 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 12574106 }, bothphases = true, assault = assaultType.mantid, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Drone Keeper Ak'thet
            [160876] = { name = L["enraged_amber_elemental"], npcid = 160876, questId = { 58306 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 11464062 }, bothphases = true, assault = assaultType.mantid, note = "Patrols in a circle around the area.", loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Enraged Amber Elemental
            [160878] = { name = L["buhgzaki_the_blasphemous"], npcid = 160878, questId = { 58307 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 6657066 }, bothphases = true, assault = assaultType.mantid, note = "Spawns on the top level of the wall.", loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Buh'gzaki the Blasphemous
            [160920] = { name = L["kaltik_the_blight"], npcid = 160920, questId = { 58310 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 17680998 }, bothphases = true, assault = assaultType.mantid, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Kal'tik the Blight
            [160922] = { name = L["needler_zhesalla"], npcid = 160922, questId = { 58311 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 14933998 }, bothphases = true, assault = assaultType.mantid, note = "Flies around The Five Sisters area.", loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Needler Zhesalla
            [160930] = { name = L["infused_amber_ooze"], npcid = 160930, questId = { 58312 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 18746346 }, bothphases = true, assault = assaultType.mantid, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Infused Amber Ooze
            [160968] = { name = L["jade_colossus"], npcid = 160968, questId = { 58295 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 17151201 }, bothphases = true, assault = assaultType.mogu, note = "Spawns deep inside the Guo-Lai Halls.", loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Jade Colossus
            [160893] = { name = L["captain_vorlek"], npcid = 160893, questId = { 58308 }, type = TYPE_ELITE, faction = FACTION_ALL, coord = { 5986420 }, bothphases = true, assault = assaultType.mantid, note = "Patrols around the top level of the wall.", loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Captain Vor'lek
            [157183] = { name = L["coagulated_anima"], npcid = 157183, questId = { 58296 }, type = TYPE_UNCOMMON, faction = FACTION_ALL, coord = { 20766232 }, bothphases = true, assault = assaultType.mogu, note = "Can spawn at any blood ritual sites in the Setting Sun Garrison.", loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Coagulated Anima
            [154087] = { name = L["zrorum_the_infinite"], npcid = 154087, questId = { 56084 }, type = TYPE_ELITE, faction = FACTION_ALL, coord = { 71644174 }, bothphases = true, assault = assaultType.blackEmpire, loot = { { droptype = DROP_GEAR_ONLY, itemID = 0, isKnown = false } } }, -- Zror'um the Infinite
...
local function getCurrentAssault(mapid)
    ...
    if textures and textures[1].fileDataIDs[1] == 3165083 then -- Uldum left
        --print('Uldum assault: aqir')
        return assaultType.aqir
    elseif textures and textures[1].fileDataIDs[1] == 3165092 then -- Uldum middle
        --print('Uldum assault: blackEmpire')
        return assaultType.blackEmpire
    elseif textures and textures[1].fileDataIDs[1] == 3165098 then -- Uldum right
        --print('Uldum assault: amathet')
        return assaultType.amathet
    elseif textures and textures[1].fileDataIDs[1] == 3155826 then -- Vale left
        --print('Vale assault: mantid')
        return assaultType.mantid
    elseif textures and textures[1].fileDataIDs[1] == 3155832 then -- Vale middle
        --print('Vale assault: mogu')
        return assaultType.mogu
    elseif textures and textures[1].fileDataIDs[1] == 3155841 then -- Vale right
        --print('Vale assault: blackEmpire')
        return assaultType.blackEmpire
    end
...
local function checkAssaults()
    for mapid, contents in pairs(rareDB) do
        if contents.zoneType ~= nil and contents.zoneType == DB_ZONE_TYPE_ASSAULT then
            --print("checkAssaults(): " .. contents.zonename .. " is an Assalt Type map. Checking status!")
...
local function checkRareAssault(mapid, npcid)
    if rareDB[mapid] ~= nil and rareDB[mapid].rares[npcid] ~= nil and rareDB[mapid].rares[npcid].assault ~= nil then
        ...
        for  i = 1, #assault, 1 do
            if i > #assault then
                --print("checkRareAssault(..mapid.., ..npcid..) Asault not active for: " .. rareDB[mapid].rares[npcid].name)
                return false
            end
            if assault[i] == rareDB[mapid].currentAssault or assault[i] == assaultType.unknown or assault[i] == assaultType.all then
                --print("checkRareAssault(..mapid.., ..npcid..) " .. rareDB[mapid].rares[npcid].name .. " Active!!!!")
                return true
            end
        end
...
local function hasValidCoord(mapid, npcid)
    ...
    --print(rareDB[mapid].rares[npcid].name .. " has an invalid coord!!!")
    return false
end
...
local function getCoordsForPhase(mapid, npcid, tomtom)
    ...
    -- if rareDB[mapid].rares[npcid].coord == nil then return 0, 0 end
