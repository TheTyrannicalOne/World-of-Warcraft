...
function MT:CreateMTFrame()
	...
	mterrorbg = CreateFrame("Frame", "MacroToolkitErrorBg", mtframe, BackdropTemplateMixin and "BackdropTemplate")
	...
	local mcopy
	local mttab1 = CreateFrame("Button", "MacroToolkitFrameTab1", mtframe, "BackdropTemplate,TabButtonTemplate")
	...
	local mttab2 = CreateFrame("Button", "MacroToolkitFrameTab2", mtframe, "BackdropTemplate,TabButtonTemplate")
	mttab2:SetID(2)
	...
	local mttab3 = CreateFrame("Button", "MacroToolkitFrameTab3", mtframe, "BackdropTemplate,TabButtonTemplate")
	mttab3:SetID(3)
