...
if AL then
	...
	AL["NOTE_183925"] = "You have to advance in the campaign (chapter 5) to unlock the [Locus Shift teleport] to reach to its position."
	...
	AL["NOTE_375478"] = "You have to advance in the campaign (chapter 5) to unlock the [Locus Shift teleport] to reach its position. Once you use the teleport, you have to jump to the platform on the right side."
