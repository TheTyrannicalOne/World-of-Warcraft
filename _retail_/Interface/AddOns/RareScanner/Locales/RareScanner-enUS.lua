...
if AL then
	...
	AL["NOTE_201016"] = "Click on the key and find 3x[Crystal]"
	...
	AL["NOTE_380822"] = "Kill the frog and then collect 3x[Crystal] that you will find on the mini islands."
