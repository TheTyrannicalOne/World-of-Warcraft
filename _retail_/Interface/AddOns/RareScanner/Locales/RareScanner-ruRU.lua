...
if AL then
	...
	AL["CMD_HELP6"] = "Включает/выключает все оповещения"
	AL["CMD_HELP7"] = "Включает/выключает оповещения о событиях"
	AL["CMD_HELP8"] = "Включает/выключает оповещения о сокровищах"
	AL["CMD_HELP9"] = "Включает/выключает оповещения о редких НИПах"
	...
	AL["ENABLE_SCAN_WORLDMAP_VIGNETTES_DESC"] = "Если настройка включена, вы будете оповещены при появлении на карте мира значка редокго НИПа, сокровища или события. Имейте в виду, что этот фильтр может сильно раздражать в местах, где значки остаются на карте в течение длительного времени."
	...
	AL["MAP_NOT_DISCOVERED_ICONS"] = "Ненайденные"
	...
	AL["MAP_SEARCHER_DISPLAY_DESC"] = "Если настройка отключена, поиская строка не будет показана на карте мира"
	...
	AL["NOTE_131735"] = "Нейтральный НИП. Как только вы его убьете, появится поросенок, который даст вам питомца [Таптаф]"
	AL["NOTE_135448"] = "Доступен лишь на эпохальной сложности. Вы должны найти [Брошенный ключ от клетки] (он появляется на поверхности мебели, стоящей вокруг), чтобы открыть камеру, в которой появляется этот череп. Оказавшись внутри, пройдите через дыру в стене, чтобы попасть в комнату с ведром. Нажмите на него, чтобы вызвать редкого НИПа."
	...
	AL["NOTE_149886"] = "Появляется лишь однажды, когда ваш персонаж заходит в Королевскую библиотеку. Добавлен в игру в качестве дани уважения Стэну Ли из Marvel."
	AL["NOTE_149887"] = "Появляется лишь однажды, когда ваш персонаж заходит в здание, расположенное по этим координатам. Добавлен в игру в качестве дани уважения Стэну Ли из Marvel."
	...
	AL["PROFILES"] = "Профили"
	AL["RAIDS"] = "Рейды"
	AL["RESET_POSITION"] = "Сброс положения"
