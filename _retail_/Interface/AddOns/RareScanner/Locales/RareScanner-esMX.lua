...
if AL then
	...
	AL["CMD_HELP2"] = "- Escribe \"/rarescanner show\" para mostrar todos los iconos en el mapa del mundo"
	AL["CMD_HELP3"] = "- Escribe \"/rarescanner hide\" para esconder todos los iconos en el mapa del mundo"
	AL["CMD_HELP4"] = "- Escribe \"/rarescanner toggle\" para mostrar/esconder todos los iconos en el mapa del mundo"
	AL["CMD_HELP5"] = "- Escribe \"/rarescanner toggle rares\" o \"/rarescanner tr\" para mostrar/esconder todos los iconos de PNJs raros en el mapa del mundo"
	AL["CMD_HELP6"] = "- Escribe \"/rarescanner toggle events\" o \"/rarescanner te\" para mostrar/esconder todos los iconos de eventos en el mapa del mundo"
	AL["CMD_HELP7"] = "- Escribe \"/rarescanner toggle treasures\" o \"/rarescanner tt\" para mostrar/Esconder todos los iconos de tesoros en el mapa del mundo"
	...
	AL["NOTE_156709"] = "Tienes que matar [Faceless Despoiler] (NPC normal) para forzar su aparición."
	AL["NOTE_157162"] = "Está dentro del templo. La entrada se encuentra en las coordenadas 22,24."
	AL["NOTE_158531"] = "Tienes que matar [Voidwarped Neferset] (NPC normal) para forzar su aparición."
	AL["NOTE_158632"] = "Tienes que matar [Burbling Fleshbeast] (NPC normal) para forzar su aparición."
	AL["NOTE_158706"] = "Tienes que matar [Oozing Putrefaction] (NPC normal) para forzar su aparición."
	AL["NOTE_159087"] = "Tienes que matar [N'Zoth Bonestripper] (NPC normal) para forzar su aparición."
