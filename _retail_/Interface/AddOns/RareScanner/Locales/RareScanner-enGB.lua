...
if AL then
	...
	AL["COLLECTION_FILTERS"] = "Filters by collections"
	AL["COLLECTION_FILTERS_APPEARENCE"] = "Appearences"
	AL["COLLECTION_FILTERS_APPEARENCE_DESC"] = "When enabled you will be alerted about NPCs/Containers that drop missing Appearences that the current character is missing. This doesn't apply to Appearences that you cannot transmog with this character."
	AL["COLLECTION_FILTERS_APPLY"] = "Apply filters"
	AL["COLLECTION_FILTERS_APPLY_DESC"] = "Press this button to start the operation."
	AL["COLLECTION_FILTERS_GLOBAL_TYPE_DESC"] = "When enabled you will be alerted about NPCs/Containers that drop missing %s."
	AL["COLLECTION_FILTERS_MOUNTS"] = "Mounts"
	AL["COLLECTION_FILTERS_ONLY_MAP_DESC"] = "When enabled you will still get alerts from filtered Container/NPCs but they won't show up in your world map. When disabled you won't get alerts from filtered Container/NPCs at all."
	AL["COLLECTION_FILTERS_PETS"] = "Pets"
	AL["COLLECTION_FILTERS_PROFILE_BACKUP"] = "Create a copy of your current profile to apply the filters to"
	AL["COLLECTION_FILTERS_PROFILE_BACKUP_CREATED"] = "Created a new profile based on the current one named %s."
	AL["COLLECTION_FILTERS_PROFILE_BACKUP_DESC"] = "When enabled the filters will be applied to a new profile copied from your current profile. This will give you the option to switch back to your current profile if you aren't happy with the results. It is recommended to enable this option if you are going to filter entities by missing appearances and you are using the 'Default' profile which is shared between all your characters."
	AL["COLLECTION_FILTERS_TEXT1"] = "Choose the types of collections that you are interested in and hit the button [%s]."
	AL["COLLECTION_FILTERS_TEXT2"] = "This operation will filter every single Rare NPC and Container whose loot doesn't match with the types selected or you have already collected. IMPORTANT: Be aware that this operation will override your current filters."
	AL["COLLECTION_FILTERS_TEXT3"] = "Once the filters are applied, you can modify them using the panels [%s] and [%s] in the addons settings."
	AL["COLLECTION_FILTERS_TOYS"] = "Toys"
	AL["COLLECTION_FILTERS_TYPES"] = "Types of collections"
	AL["COLLECTIONS_AUTO_FILTER_ON_COLLECT"] = "Auto filter entities when finding missing collections"
	AL["COLLECTIONS_AUTO_FILTER_ON_COLLECT_DESC"] = "When enabled entities will be auto-filtered as soon as the missing items that they drop are added to the collection."
	...
	AL["CUSTOM_NPC_COORDINATES_DESC"] = "(Obligatory) Coordinates where the NPC can spawn. Introduce the coordinates with the next format: X1-Y1,X2-Y2,.... For example: 0614-6712,75152-4123 (means that the NPC can spawn at the coordinates '6.14-67.12' and '75.152-41.23'). The skull will appear in your map at the first set of coordinates. The rest of coordinates will be used in the overlay layer."
	...
	AL["MAP_TOOLTIPS_SCALE_DESC"] = "This will adjust the scale of the tooltips in the worldmap, including loot and achievements tooltips."
	...
	AL["START_COLLECTIONS_SCAN"] = "This process is going to look for missing collections in the entire RareScanner's database. It is a heavy operation that might freeze your game for a few seconds. Do you want to continue?"
	AL["TEST"] = "Launch Test"
