...
if AL then
	...
	AL["CMD_DISABLE_CONTAINERS_ALERTS"] = "Les alertes trésors de RareScanner sont désactivées"
	AL["CMD_DISABLE_EVENTS_ALERTS"] = "Les alertes événements de RareScanner sont désactivées"
	AL["CMD_DISABLE_RARES_ALERTS"] = "Les alertes PNJ rares de RareScanner sont désactivées"
	AL["CMD_HELP1"] = "Liste des commandes"
	AL["CMD_HELP2"] = "Montre/efface tous les icônes sur la carte mondiale "
	AL["CMD_HELP3"] = "Montre/efface tous les icônes des événements sur la carte mondiale"
	AL["CMD_HELP4"] = "Montre/efface tous les icônes des trésors sur la carte mondiale"
	AL["CMD_HELP5"] = "Montre/efface tous les icônes de PNJs rare sur la carte mondiale"
	AL["CMD_HELP6"] = "Activez/désactivez toutes les alertes"
	AL["CMD_HELP7"] = "Activez/désactivez les alertes d'événements"
	AL["CMD_HELP8"] = "Activez/désactivez les alertes de trésors"
	AL["CMD_HELP9"] = "Activez/désactivez les alertes de PNJ rares"
	...
	AL["EVENT"] = "Événement"
	AL["FILTER"] = "Filtres PNJ"
	AL["FILTER_NPCS_ONLY_MAP"] = "Activez uniquement les filtres sur la carte mondiale"
