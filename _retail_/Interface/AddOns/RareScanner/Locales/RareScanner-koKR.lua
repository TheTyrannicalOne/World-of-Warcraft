...
if AL then
	...
	AL["CMD_HELP3"] = "세계 지도에 이벤트 아이콘 표시/숨기기"
	AL["CMD_HELP4"] = "세계 지도에 보물 아이콘 표시/숨기기"
	...
	AL["CUSTOM_NPC_VALIDATION_ITEM"] = "소개된 항목 ID가 올바르지 않습니다. 문자열은 다음 형식이어야 합니다: ID1, ID2, ..."
	...
	AL["ENABLE_SEARCHING_RARE_TOOLTIP"] = "이 희귀 NPC에 대해 알림을 켭니다."
	...
	AL["EXPLORER_NO_MISSING_APPEARANCES"] = "놓친 형상 없음"
	AL["EXPLORER_NO_MISSING_MOUNTS"] = "놓친 탈것 없음"
	AL["EXPLORER_NO_MISSING_PETS"] = "놓친 애완동물 없음"
	AL["EXPLORER_NO_MISSING_TOYS"] = "놓친 장난감 없음"
	...
	AL["FILTER_RARE_LIST_DESC"] = "이 희귀 NPC에 대한 검색을 켜고 끕니다. 끄면 이 NPC를 찾았을 때 알림을 받지 않습니다."
	AL["FILTER_ZONE"] = "지역"
	...
	AL["LOOT_FILTER_CONDUIT_ITEMS"] = "사용할 수 없는 도관 필터"
