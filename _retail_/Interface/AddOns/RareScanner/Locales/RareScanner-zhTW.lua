...
if AL then
	...
	AL["FILTER_CONTAINERS_ONLY_ALERTS_DESC"] = "啟用後，你仍然會在世界地圖上看到被過濾的寶箱，但你不會得到視覺/音效警報。當禁用時，你不會在你的世界地圖上看到被過濾的寶箱，也不會得到視覺/音效警報。"
	AL["FILTER_CONTAINERS_ONLY_MAP_DESC"] = "啟用後，你仍然會收到來自被過濾寶箱的警報，但它們不會顯示在你的世界地圖上。當禁用時，你不會在世界地圖上看到被過濾的寶箱，也不會得到視覺/音效警報。"
	...
	AL["FILTER_ONLY_ALERTS"] = "只在視覺/聲音提醒上啟用過濾"
