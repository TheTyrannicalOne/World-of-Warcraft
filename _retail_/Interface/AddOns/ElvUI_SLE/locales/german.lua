...
L["%sCtrl+Left Click|r a person's line to invite them."] = "%sCtrl+LinksKlick|r die Linie einer Person, um sie einzuladen."
...
L["%sLeft Click|r a person's line to whisper them."] = "%sLinksklick|r die Linie einer Person, um sie anzuflüstern."
...
L["%sRight Click|r a person's line that has a bnet broadcast icon to expand it."] = "%sRechtsklick|r a person's line that has a bnet broadcast icon to expand it."
...
L["Allow pasting of your coordinates in chat editbox via holding shift and clicking on the location name."] = "Ermöglichen Sie das Einfügen Ihrer Koordinaten in das Chat-Bearbeitungsfeld, indem Sie die Umschalttaste gedrückt halten und auf den Standortnamen klicken."
...
L["Always Compare Items"] = "Artikel immer vergleichen"
L["Amount"] = "Anzahl"
...
L["Apply unlocking skills in trade window the same way as in deconstruction mode for bags."] = "Wenden Sie Freischaltfähigkeiten im Handelsfenster genauso an wie im Zerstörungsmodus für Taschen."
...
L["Automatically plant seeds to the nearest tilled soil if one is not already selected."] = "Pflanzen Sie Samen automatisch auf den nächstgelegenen Boden, falls noch keiner ausgewählt ist."
...
L["Automatically release body when killed inside a battleground."] = "Lass den Körper automatisch frei, wenn er auf einem Schlachtfeld getötet wird."
...
L["By default menu's width will be equal to the location panel width. Checking this option will allow you to set own width."] = "Standardmäßig entspricht die Breite des Menüs der Breite des Positionsfensters. Wenn Sie diese Option aktivieren, können Sie die eigene Breite festlegen."
L["Castbar Texture"] = "Zabuberleisten Textur"
L["Categories"] = "Kategorien"
L["Change Elv's options limits"] = "Ändere Elv's Optionsbegrenzung"
L["Change the message style."] = "Andere den Nachrichten Stil"
L["Change the position from where seed bars will grow."] = "Ändere die Position, an der die Samen Leiste wachsen."
...
L["Chat Setup Delay"] = "Verzögerung der Chat-Einrichtung"
L["Check for rebirth mechanics"] = "Überprüfen Sie die Wiedergeburtsmechanik"
...
L["Click to toggle the AddOn Manager frame."] = "Klicken um den AddOn Manager-Frame umzuschalten."
...
L["Create a button for applying selected enchant on the scroll."] = "Erstelle eine Schaltfläche zum Anwenden der ausgewählten Verzauberung auf die Schriftrolle."
...
L["Dead Indicator"] = "Tot Indikator"
...
L["Enables a different look/feel vehicle bar."] = "Aktiviert eine andere Fahrzeugleiste mit Erscheinungsbild."
...
L["Enhanced Vehicle Bar"] = "Verbesserte Fahrzeugleiste"
...
L["Hold this button while clicking to allow fishing action."] = "Halte diese Taste gedrückt, während Sie auf klicken, um Angelaktionen zuzulassen."
L["Honor Style"] = "Ehre Stil"
L["HS Toys Order"] = "HS Spielzeug Sortierung"
...
L["Item Info Size"] = "Gegenstands Größe"
...
L["Items listed here will be ignored in deconstruction mode. Add names or item links, entries must be separated by comma."] = "Die hier aufgeführten Elemente werden im Zerstörungsmodus ignoriert. Fügen Sie Namen oder Elementverknüpfungen hinzu, Einträge müssen durch Komma getrennt werden."
...
L["Minimap Alpha"] = "Minikarten Alpha"
...
L["Options for customizing Blizzard Raid Manager \"O - > Raid\""] = "Optionen zum Anpassen von Blizzard Raid Manager"
...
L["Pet Battle Status"] = "Tierkampf Status"
L["Pet Battles skinning"] = "Haustierkampf Skin"
L["Play sound when killing blows popup is shown."] = "Es wird ein Sound abgespielt, wenn das Popup Schläge beenden angezeigt wird."
L["Player Frame Indicators"] = "Player Frame Anzeigen"
...
L["Raid Progression"] = "Schlachtzugsvortschritt"
L["Raid Utility Mouse Over"] = "Schlachtzugs Utility Mouse Over"
L["RAID_ANTO"] = "Antorus"
L["RAID_DAZALOR"] = "BfDA"
L["RAID_EN"] = "EN"
...
L["Remember positions of frames after moving them."] = "Merke die Positionen der Frames, nachdem Du sie verschoben hast."
L["Remember"] = "Merken"
...
L["Right click on the location panel will bring up a menu with available options for relocating your character (e.g. Hearthstones, Portals, etc)."] = "Wenn Du mit der rechten Maustaste auf das Positionsfeld klickst, wird ein Menü mit verfügbaren Optionen zum Verschieben Deines Charakters angezeigt  (z.B. Hearthstones, Portale, etc)."
...
L["Set the height of Error Frame. Higher frame can show more lines at once."] = "Stelle die Höhe des Fehlerrahmens ein. Ein höherer Rahmen kann mehr Linien gleichzeitig anzeigen."
L["Set the modifier key for placing world markers."] = "Setzt eine modifierungs Taste um eine Weltmarkierung zu setzen."
L["Set the offset from the bottom border of the screen."] = "Stelle den Versatz vom unteren Bildschirmrand ein."
L["Set the offset from the left border of the screen."] = "Stelle den Versatz vom linken Bildschirmrand ein."
L["Set the offset from the right border of the screen."] = "Stelle den Versatz vom rechten Bildschirmrand ein."
L["Set the offset from the top border of the screen."] = "Stelle den Versatz vom oberen Bildschirmrand ein."
...
L["Set the width of Error Frame. Too narrow frame may cause messages to be split in several lines"] = "Stelle die Breite des Fehlerrahmens ein. Ein zu enger Rahmen kann dazu führen, dass Nachrichten in mehrere Zeilen aufgeteilt werden"
...
L["Show glow on bag button"] = "Zeige das Leuchten auf dem Taschenknopf"
L["Show glow on the deconstruction button in bag when deconstruction mode is enabled.\nApplies on next mode toggle."] = "Zeigen Sie das Leuchten auf der Zerstörungsschaltfläche in der Tasche an, wenn der Zerstörungsmodus aktiviert ist.\nGilt für das Umschalten im nächsten Modus."
...
L["Show goal time markers on the timer bar"] = "Zeige Zielzeitmarkierungen in der Timer-Leiste"
L["Show hearthstone type items in the list."] = "Elemente vom Typ Hearthstone in der Liste anzeigen."
...
L["Show items used only by engineers when the profession is learned."] = "Zeigen Sie Elemente an, die nur von Ingenieuren verwendet werden, wenn der Beruf erlernt ist."
L["Show Jewelcrafting Tokens"] = "Zeige Juwelenschleifen Abzeichen"
L["Show level"] = "Zeige Level"
L["Show Marks"] = "Ziege Markierungen"
...
L["Show raid experience of character in tooltip (requires holding shift)."] = "Zeigen Sie die Raid-Erfahrung des Charakters im Tooltip an (erfordert das Halten der Umschalttaste)."
...
L["Show the name on location your Heathstone is bound to."] = "Zeige den Namen an dem Ort an, an den Ihr Heathstone gebunden ist."
...
L["Show your PvP killing blows as a popup."] = "Zeigen Sie Ihre PvP-Killing-Schläge als Popup."
...
L["Shows an icon on party or raid unitframes for people that are offline."] = "Zeigt ein Symbol auf Gruppen- oder Schlachtzugsrahmen für Personen an, die offline sind."
...
|cff3cbf27spec|r - specified spec. Verwendungszweck [spec:<number>] number is the index of desired spec as seen in spec tab;
