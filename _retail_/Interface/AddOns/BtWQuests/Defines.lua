BtWQuests = {
    Constant = {
        Expansions = {
            ...
            BurningCrusade = LE_EXPANSION_BURNING_CRUSADE,
            WrathOfTheLichKing = LE_EXPANSION_WRATH_OF_THE_LICH_KING,
            Cataclysm = LE_EXPANSION_CATACLYSM,
            MistsOfPandaria = LE_EXPANSION_MISTS_OF_PANDARIA,
            WarlordsOfDraenor = LE_EXPANSION_WARLORDS_OF_DRAENOR,
            BattleForAzeroth = LE_EXPANSION_BATTLE_FOR_AZEROTH,
        },
        Faction = {
            Alliance = "Alliance",
            Horde = "Horde",
...
BTWQUESTS_EXPANSION_THE_BURNING_CRUSADE = LE_EXPANSION_BURNING_CRUSADE
...
BTWQUESTS_EXPANSION_BATTLE_FOR_AZEROTH = LE_EXPANSION_BATTLE_FOR_AZEROTH or (LE_EXPANSION_LEGION + 1)
