...
AAP.QuestStepListListingStartAreas = {}
AAP.QuestStepListListingStartAreas["Kalimdor"] = {}
AAP.QuestStepListListingStartAreas["EasternKingdom"] = {}
if (AAP.Class[3] == 6 and AAP.Level < 33) then
	AAP.QuestStepListListingStartAreas["EasternKingdom"]["23-ScarletEnclave"] = "01-30 Death Knight Start"
elseif (AAP.Class[3] == 12 and AAP.Level < 33) then
	AAP.QuestStepListListingStartAreas["Kalimdor"]["672-Mardum"] = "01-30 Demon Hunter Start"
elseif (AAP.Race == "Goblin" and AAP.Level < 33) then
	AAP.QuestStepListListingStartAreas["Kalimdor"] = {
		["194-Kezan"] = "01-30 Goblin Start (Kezan)",
		["174-LostIsles"] = "01-30 Goblin Start (Lost Isles)",
	}
end
if (AAP.Race == "Orc" and AAP.Level < 33) then
	AAP.QuestStepListListingStartAreas["Kalimdor"]["1-ValleyOfTrialsOrc"] = "01-10 Orc Start"
elseif (AAP.Race == "Scourge" and AAP.Level < 33) then
	AAP.QuestStepListListingStartAreas["Kalimdor"]["18-TirisfalGladesUndead"] = "01-10 Scourge Start"
elseif (AAP.Race == "BloodElf" and AAP.Level < 33) then
	AAP.QuestStepListListingStartAreas["Kalimdor"]["94-EversongWoodsBloodElf"] = "01-10 Blood Elf Start"
elseif (AAP.Class[3] == 1 and AAP.Race == "Troll" and AAP.Level < 33) then
	AAP.QuestStepListListingStartAreas["Kalimdor"]["1-EchoIslesTrollWar"] = "01-10 Troll Start"
elseif (AAP.Class[3] == 3 and AAP.Race == "Troll" and AAP.Level < 33) then
	AAP.QuestStepListListingStartAreas["Kalimdor"]["1-EchoIslesTrollHunter"] = "01-10 Troll Start"
elseif (AAP.Class[3] == 4 and AAP.Race == "Troll" and AAP.Level < 33) then
	AAP.QuestStepListListingStartAreas["Kalimdor"]["1-EchoIslesTrollRogue"] = "01-10 Troll Start"
elseif (AAP.Class[3] == 5 and AAP.Race == "Troll" and AAP.Level < 33) then
	AAP.QuestStepListListingStartAreas["Kalimdor"]["1-EchoIslesTrollPriest"] = "01-10 Troll Start"
elseif (AAP.Class[3] == 7 and AAP.Race == "Troll" and AAP.Level < 33) then
	AAP.QuestStepListListingStartAreas["Kalimdor"]["1-EchoIslesTrollShaman"] = "01-10 Troll Start"
elseif (AAP.Class[3] == 8 and AAP.Race == "Troll" and AAP.Level < 33) then
	AAP.QuestStepListListingStartAreas["Kalimdor"]["1-EchoIslesTrollMage"] = "01-10 Troll Start"
elseif (AAP.Class[3] == 9 and AAP.Race == "Troll" and AAP.Level < 33) then
	AAP.QuestStepListListingStartAreas["Kalimdor"]["1-EchoIslesTrollWarlock"] = "01-10 Troll Start"
elseif (AAP.Class[3] == 10 and AAP.Race == "Troll" and AAP.Level < 33) then
	AAP.QuestStepListListingStartAreas["Kalimdor"]["1-EchoIslesTrollMonk"] = "01-10 Troll Start"
elseif (AAP.Class[3] == 11 and AAP.Race == "Troll" and AAP.Level < 33) then
	AAP.QuestStepListListingStartAreas["Kalimdor"]["1-EchoIslesTrollDruid"] = "01-10 Troll Start"
end



AAP.QuestStepListListingZone = {
	["01-10 Orc Start"] = 1,
	["01-10 Troll Start"] = 1,
...
AAP.QuestStepListListing["Kalimdor"] = {
...
AAP["Kalimdor"][1] = 1
AAP["ShadowlandsDB"] = {}
AAP["ShadowlandsDB"][1409] = 1
AAP["ShadowlandsDB"][1525] = 1
AAP["ShadowlandsDB"][1533] = 1
AAP["ShadowlandsDB"][1536] = 1
AAP["ShadowlandsDB"][1565] = 1
AAP["ShadowlandsDB"][1613] = 1
AAP["ShadowlandsDB"][1670] = 1
