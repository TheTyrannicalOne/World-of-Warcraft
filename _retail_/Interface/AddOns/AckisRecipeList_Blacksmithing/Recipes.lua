...
function module:InitializeRecipes()
	...
	recipe:AddTrainer(514, 1241, 2836, 2998, 3136, 3174, 3355, 3478, 3557, 4258, 4596, 4888, 5164, 5511, 7230, 7231, 11146, 11177, 11178, 15400, 16583, 16669, 16724, 16823, 17245, 19341, 29924, 33609, 33631, 37072, 43429, 44781, 45548, 47384, 47396, 47400, 47418, 47419, 47421, 47431, 48619, 49885, 57620, 65043, 85917, 86048, 92183, 92264, 92265, 106655)
	...
	recipe:AddTrainer(514, 1241, 2836, 2998, 3136, 3174, 3355, 3478, 3557, 4258, 4596, 4888, 5164, 5511, 7230, 7231, 11146, 11177, 11178, 15400, 16583, 16669, 16724, 16823, 17245, 19341, 29924, 33609, 33631, 37072, 43429, 44781, 45548, 49885, 92264, 92265)
	...
	recipe:SetItemFilterType("BLACKSMITHING_WRIST")
	recipe:AddTrainer(514, 1241, 2836, 2998, 3136, 3174, 3355, 3478, 3557, 4258, 4596, 4888, 5164, 5511, 7230, 7231, 11146, 11177, 11178, 15400, 16583, 16669, 16724, 16823, 17245, 19341, 29924, 33609, 33631, 37072, 44781, 45548, 92264, 92265)
	...
	recipe:SetItemFilterType("BLACKSMITHING_ITEM_ENHANCEMENT")
	recipe:AddFilters(F.DPS)
	recipe:AddTrainer(514, 1241, 2836, 2998, 3136, 3174, 3355, 3478, 3557, 4258, 4596, 4888, 5164, 5511, 7230, 7231, 11146, 11177, 11178, 16583, 16669, 16724, 16823, 17245, 19341, 29924, 33609, 33631, 37072, 44781, 45548, 92264, 92265)
	...
	recipe:SetItemFilterType("BLACKSMITHING_CHEST")
	recipe:AddFilters(F.CASTER, F.DPS, F.HEALER)
	recipe:AddTrainer(514, 1241, 2836, 2998, 3136, 3174, 3355, 3478, 3557, 4258, 4596, 4888, 5164, 5511, 7230, 7231, 11146, 11177, 11178, 15400, 16669, 16724, 16823, 17245, 19341, 33609, 33631, 37072, 44781, 45548, 92264, 92265)
	...
	recipe:SetItemFilterType("BLACKSMITHING_SHOULDER")
	recipe:AddFilters(F.DPS, F.TANK)
	recipe:AddTrainer(514, 1241, 2836, 2998, 3136, 3174, 3355, 3478, 4258, 4596, 4888, 5164, 5511, 7230, 7231, 11146, 11177, 11178, 16583, 16669, 16724, 16823, 17245, 19341, 29924, 33609, 33631, 37072, 44781, 45548, 92264, 92265)
	...
	recipe:SetItemFilterType("BLACKSMITHING_HANDS")
	recipe:AddFilters(F.CASTER, F.DPS, F.HEALER)
	recipe:AddTrainer(1241, 4258, 11146, 16583, 16823, 19341, 20124, 20125, 29924, 33609, 33631, 33675, 92264, 92265)
	...
	recipe:SetItemFilterType("BLACKSMITHING_LEGS")
	recipe:AddFilters(F.DPS, F.TANK)
	recipe:AddTrainer(16823, 19341, 26564, 26904, 26952, 26981, 26988, 27034, 28694, 29505, 29506, 29924, 33591, 33609, 33631, 92264, 92265)
	...
	recipe:SetItemFilterType("BLACKSMITHING_CHEST")
	recipe:AddFilters(F.DPS, F.TANK)
	recipe:AddTrainer(1241, 4258, 11146, 16823, 19341, 26564, 26904, 26952, 26981, 26988, 27034, 28694, 29505, 29506, 29924, 33591, 33609, 33631, 92264, 92265)
	...
	recipe:SetItemFilterType("BLACKSMITHING_TWO_HAND_MACE")
	recipe:AddFilters(F.CASTER, F.DPS, F.HEALER)
	recipe:AddTrainer(1241, 4258, 11146, 16823, 19341, 26564, 26904, 26952, 26981, 26988, 27034, 28694, 29505, 29506, 33591, 33609, 33631, 92264, 92265)
	...
	recipe:SetItemFilterType("BLACKSMITHING_MATERIALS")
	recipe:AddTrainer(514, 1241, 2998, 3136, 3174, 3355, 4258, 4596, 4888, 5164, 5511, 7230, 7231, 11146, 11177, 11178, 16669, 16724, 16823, 17245, 19341, 33609, 33631, 37072, 44781, 45548, 92264, 92265)
	...
	recipe:SetItemFilterType("BLACKSMITHING_HEAD")
	recipe:AddTrainer(4258, 11146, 16823, 19341, 33609, 33631, 64058, 64085, 65114, 65129, 92264, 92265)
	...
	recipe = AddRecipe(171708, V.WOD, Q.COMMON)
	recipe:SetSkillLevels(1, 1, 100, 100, 101)
	recipe:SetRecipeItem(116743, "BIND_ON_PICKUP")
	recipe:SetCraftedItem(128015, "BIND_ON_EQUIP")
	recipe:SetItemFilterType("BLACKSMITHING_ITEM_ENHANCEMENT")
	recipe:AddVendor(77359, 79867, 87062, 87550)

	-- Steelforged Essence -- 171710
	recipe = AddRecipe(171710, V.WOD, Q.COMMON)
	recipe:SetSkillLevels(1, 1, 100, 100, 101)
	recipe:SetRecipeItem(116745, "BIND_ON_PICKUP")
	recipe:SetCraftedItem(128016, "BIND_ON_EQUIP")
	recipe:SetItemFilterType("BLACKSMITHING_ITEM_ENHANCEMENT")
	recipe:AddVendor(77359, 79867, 87062, 87550)
	...
	recipe = AddRecipe(187490, V.WOD, Q.COMMON)
	recipe:SetSkillLevels(1, 1, 100, 100, 100)
	recipe:SetRecipeItem(127725, "BIND_ON_PICKUP")
	recipe:SetCraftedItem(127713, "BIND_ON_EQUIP")
	recipe:SetItemFilterType("BLACKSMITHING_ITEM_ENHANCEMENT")
	recipe:AddVendor(90894, 91030)

	-- Mighty Truesteel Essence -- 187491
	recipe = AddRecipe(187491, V.WOD, Q.COMMON)
	recipe:SetSkillLevels(1, 1, 100, 100, 100)
	recipe:SetRecipeItem(127727, "BIND_ON_PICKUP")
	recipe:SetCraftedItem(127714, "BIND_ON_EQUIP")
	recipe:SetItemFilterType("BLACKSMITHING_ITEM_ENHANCEMENT")
	recipe:AddVendor(90894, 91030)

	-- Savage Steelforged Essence -- 187514
	recipe = AddRecipe(187514, V.WOD, Q.COMMON)
	recipe:SetSkillLevels(1, 1, 100, 100, 100)
	recipe:SetRecipeItem(127743, "BIND_ON_PICKUP")
	recipe:SetCraftedItem(127731, "BIND_ON_EQUIP")
	recipe:SetItemFilterType("BLACKSMITHING_ITEM_ENHANCEMENT")
	recipe:AddVendor(90894, 91030)

	-- Savage Truesteel Essence -- 187515
	recipe = AddRecipe(187515, V.WOD, Q.COMMON)
	recipe:SetSkillLevels(1, 1, 100, 100, 100)
	recipe:SetRecipeItem(127745, "BIND_ON_PICKUP")
	recipe:SetCraftedItem(127732, "BIND_ON_EQUIP")
	recipe:SetItemFilterType("BLACKSMITHING_ITEM_ENHANCEMENT")
	recipe:AddVendor(90894, 91030)
	...
	-- Empyrial Rivets -- 248864
	recipe = AddRecipe(248864, V.LEGION, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Empyrial Chest Plate -- 248867
	recipe = AddRecipe(248867, V.LEGION, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Empyrial Back Plate -- 248869
	recipe = AddRecipe(248869, V.LEGION, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Empyrial Breastplate -- 248870
	recipe = AddRecipe(248870, V.LEGION, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)
	...
	recipe:AddTrainer(514, 2998, 3174, 3355, 4596, 4888, 5164, 5511, 7230, 7231, 11177, 11178, 16669, 16724, 17245, 37072, 44781, 45548)
