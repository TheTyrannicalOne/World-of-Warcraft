...
function module:InitializeRecipes()
	...
	recipe:AddTrainer(1103, 1346, 2399, 2627, 3004, 3363, 3484, 3523, 3704, 4159, 4576, 4578, 5153, 9584, 11052, 11557, 16366, 16640, 16729, 17487, 18749, 43428, 44783, 45559, 47384, 47396, 47400, 47418, 47419, 47421, 47431, 48619, 49885, 57405, 57620, 65043, 86004)
	...
	recipe:AddTrainer(1103, 1346, 2399, 2627, 3004, 3363, 3484, 3523, 3704, 4159, 4576, 4578, 5153, 9584, 11052, 11557, 16366, 16640, 16729, 17487, 18749, 43428, 44783, 45559, 47384, 47396, 47400, 47418, 47419, 47421, 47431, 48619, 49885, 57405, 57620, 65043, 85910, 86004)
	...
	recipe:AddTrainer(1103, 1346, 2399, 2627, 3004, 3363, 3484, 3523, 3704, 4159, 4576, 4578, 5153, 9584, 11052, 11557, 16366, 16640, 16729, 17487, 18749, 43428, 44783, 45559, 49885, 57405)
	...
	recipe:SetItemFilterType("TAILORING_BACK")
	recipe:AddFilters(F.CASTER, F.HEALER)
	recipe:AddTrainer(1103, 1346, 2399, 2627, 3004, 3363, 3484, 3523, 3704, 4159, 4576, 4578, 5153, 9584, 11052, 11557, 16366, 16640, 16729, 17487, 18749, 44783, 45559, 57405)
	...
	recipe:SetItemFilterType("TAILORING_LEGS")
	recipe:AddFilters(F.CASTER, F.HEALER)
	recipe:AddTrainer(1103, 1346, 2399, 2627, 3004, 3363, 3484, 3523, 4159, 4576, 4578, 5153, 9584, 11052, 11557, 16640, 16729, 17487, 27001, 44783, 45559, 57405)
	...
	recipe:SetItemFilterType("TAILORING_MATERIALS")
	recipe:AddTrainer(2399, 3363, 3484, 3523, 4159, 4578, 11557, 18749, 18772, 33613, 33636, 33684, 44783, 57405)
	...
	recipe:SetItemFilterType("TAILORING_MISC")
	recipe:AddTrainer(2399, 3363, 3484, 3523, 4159, 4578, 11557, 26914, 26964, 26969, 27001, 28699, 33580, 44783, 57405)
	...
	recipe:SetItemFilterType("TAILORING_BACK")
	recipe:AddFilters(F.CASTER, F.DPS, F.HEALER)
	recipe:AddTrainer(1103, 1346, 2399, 2627, 3004, 3363, 3484, 3523, 3704, 4159, 4576, 4578, 5153, 9584, 11052, 11557, 16366, 16640, 16729, 17487, 43428, 44783, 45559, 49885, 57405)
	...
	recipe:SetItemFilterType("TAILORING_WAIST")
	recipe:AddFilters(F.CASTER, F.DPS, F.HEALER)
	recipe:AddTrainer(1103, 1346, 2399, 2627, 3004, 3363, 3484, 3523, 4159, 4576, 4578, 5153, 9584, 11052, 11557, 16640, 16729, 17487, 44783, 45559, 57405)
	...
	recipe:SetItemFilterType("TAILORING_BACK")
	recipe:AddFilters(F.CASTER, F.HEALER)
	recipe:AddTrainer(1103, 1346, 2627, 3004, 3363, 3484, 3523, 4159, 4576, 4578, 5153, 9584, 11052, 11557, 16640, 16729, 17487, 45559, 57405)
	...
	recipe:SetItemFilterType("TAILORING_SHOULDER")
	recipe:AddTrainer(3363, 4159, 11557, 16366, 57405, 93525, 93542)
	...
	recipe = AddRecipe(330247, V.SHA, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Relic of the Past II -- 330248
	recipe = AddRecipe(330248, V.SHA, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Relic of the Past III -- 330249
	recipe = AddRecipe(330249, V.SHA, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Relic of the Past IV -- 330250
	recipe = AddRecipe(330250, V.SHA, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Relic of the Past V -- 330251
	recipe = AddRecipe(330251, V.SHA, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Relic of the Past I -- 330252
	recipe = AddRecipe(330252, V.SHA, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Relic of the Past II -- 330253
	recipe = AddRecipe(330253, V.SHA, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Relic of the Past III -- 330254
	recipe = AddRecipe(330254, V.SHA, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Relic of the Past IV -- 330255
	recipe = AddRecipe(330255, V.SHA, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Relic of the Past V -- 330256
	recipe = AddRecipe(330256, V.SHA, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)
	...
	-- Cloak of Camouflage -- 338267
	recipe = AddRecipe(338267, V.SHA, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Bolt of Ardensilk Cloth -- 338269
	recipe = AddRecipe(338269, V.SHA, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Ardensilk Cloth -- 338270
	recipe = AddRecipe(338270, V.SHA, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Woven Gossamer Tunic -- 338271
	recipe = AddRecipe(338271, V.SHA, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Bolt of Woven Gossamer -- 338272
	recipe = AddRecipe(338272, V.SHA, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Gossamer Cloth -- 338273
	recipe = AddRecipe(338273, V.SHA, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Haunting Hood -- 338275
	recipe = AddRecipe(338275, V.SHA, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Bolt of Bleakcloth -- 338276
	recipe = AddRecipe(338276, V.SHA, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Bleakcloth -- 338277
	recipe = AddRecipe(338277, V.SHA, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Looming Tapestry -- 338278
	recipe = AddRecipe(338278, V.SHA, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Bolt of Prideweave -- 338279
	recipe = AddRecipe(338279, V.SHA, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Prideweave Cloth -- 338280
	recipe = AddRecipe(338280, V.SHA, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)
