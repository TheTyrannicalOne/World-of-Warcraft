...
L["Drag to set the widget scale."] = "拖动以调整微件框体的缩放。"
L["Drag to size"] = "尺寸调节"
L["Dragon Soul"] = "巨龙之魂"
L["Dragonblight"] = "龙骨荒野"
...
L["If checked, you will be able to change the position and scale of the focus frame."] = "勾选后，你可以调整焦点框体的位置和缩放。"
...
L["Drag to set the widget scale."] = "拖拉以設定組件大小。"
...
L["If checked, you will be able to change the position and scale of the focus frame."] = "勾選後，您將可以更改焦點框架的位置與大小。"
...
L["If checked, you will be able to change the position and scale of the focus frame."] = "Если флажок установлен, то вы сможете управлять положением и масштабом фрейма фокуса."
...
L["Drag to set the widget scale."] = "드래그하여 위젯 크기를 설정합니다."
L["Dragon Soul"] = "용의 영혼"
...
L["If checked, you will be able to change the position and scale of the focus frame."] = "주시 프레임의 위치와 크기를 변경할 수 있습니다."
...
L["Don't accept daily quests automatically"] = "Tägliche Quests nicht automatisch annehmen."
L["Don't accept weekly quests automatically"] = "Wöchentliche Quests nicht automatisch annehmen."
L["Draenor"] = "Draenor"
...
L["Hide level-up display"] = "LevelUp Anzeige verbergen"
...
L["If checked, a minimap button will be available.|n|nClick - Toggle options panel.|n|nSHIFT/Left-click - Toggle music.|n|nSHIFT/Right-click - Toggle stopwatch.|n|nCTRL/Left-click - Toggle minimap target tracking.|n|nCTRL/Right-click - Toggle errors (if enabled).|n|nCTRL/SHIFT/Left-click - Toggle Zygor (if installed).|n|nCTRL/SHIFT/Right-click - Toggle windowed mode."] = "Wenn ausgewählt, wird ein Minimap Button angezeigt.|n|nKlick - zeigt/versteckt das Optionen Menü.|n|nSHIFT+Links-Klick - schaltet die Musik um.|n|nSHIFT+Rechts-Klick - startet/stoppt die Stoppuhr.|n|nSTRG+Links-Klick - schaltet die Minimap Aufspüroptionen um|n|nSTRG+Rechts-Klick - zeigt/versteckt Fehler (falls aktiviert).|n|nSTRG+SHIFT+Links-Klick - schaltet Zygor um (falls installiert).|n|nSTRG+SHIFT+Rechts-Klick - schaltet den Fenstermodus um."
...
L["If checked, battle shouts heard when casting specific spells will be muted."] = "Wenn ausgewählt, werden Kampfschreie die durch bestimmte Zauber ausgelöst wurden stumm geschalten."
...
L["If checked, daily quests will not be accepted automatically."] = "Wenn ausgewählt, werden tägliche Quests nicht automatisch akzeptiert."
...
L["If checked, party invitations from friends or guild members will be automatically accepted unless you are queued in Dungeon Finder."] = "Wenn ausgewählt, werden Gruppeneinladungen von Freunden oder Gilden Mitgliedern automatisch akzeptiert, ausgenommen wenn du in einer Dungeon Finder Warteschlange bist."
...
L["If checked, party sync requests from friends or guild members will be automatically accepted."] = "Wenn ausgewählt, werden Gruppensynchronisierungs Anfragen von Freunden oder Gilden Mitgliedern automatisch akzeptiert."
L["If checked, pet battle duel requests will be blocked unless the player requesting the duel is in your friends list or guild."] = "Wenn ausgewählt, werden alle Haustierkampf Anfragen blockiert, sofern der andere Spiele nicht in der Freundes Liste oder Gilde ist."
...
L["If checked, quests will be selected, accepted and turned-in automatically.|n|nQuests which have a gold, currency or crafting reagent requirement will not be turned-in automatically.|n|nYou can hold the shift key down when you talk to a quest giver to override this setting."] = [=[Wenn ausgewählt, werden Quests automatisch ausgewählt, angenommen und abgegeben.|n|nQuests die Gold, Währungs oder 
Handwerksmaterial Kosten haben werden nicht automatisch abgegeben.|n|nWenn die SHIFT-Taste gehalten wird wenn du mit einem Quest Geber sprichst, kannst du diese Funktion umgehen.]=]
...
L["If checked, resurrection requests will be accepted automatically as long as the player resurrecting you is not in combat.|n|nResurrection requests from a Brazier of Awakening or a Failure Detection Pylon will not be accepted automatically."] = "Wenn ausgewählt, werden Wiederbelebungs Anfragen automatisch akzeptiert solange der wiederbelebende Spieler nicht im Kampf ist."
...
L["If checked, the level-up display will not be shown.|n|nThe level-up display shows encounter objectives, level-ups, pet battle rewards, etc."] = "Wenn ausgewählt, wir wird die Level-up Anzeige nicht auftauchen.|n|nDie Level-up Anzeige zeigt verfügbare neue Dungeons, Haustierkampf Belohnungen etc."
...
L["If checked, the netherworld effect will be disabled."] = "Wenn ausgewählt, wird der Jenseits Bildschirm-Effekt deaktviert."
...
L["If checked, weekly quests will not be accepted automatically."] = "Wenn ausgewählt, werden Wöchentliche Quests nicht automatisch angenommen."
...
L["If checked, you will be able to change the position and scale of the player frame, target frame, ghost frame and timer bar."] = "Wenn ausgewählt, kannst du die Position und Größe des Spieler und Ziel Portraits, sowie das Geist-Fenster und des Timer Balkens ändern."
