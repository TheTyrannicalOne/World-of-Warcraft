...
L["If checked, you will be able to change the position and scale of the following frames:|n|n- Player frame|n- Target frame|n- Buffs frame|n- Widget top center frame|n- Ghost frame|n- Timer bar|n- Player power bar"] = "Si está marcada, podrá cambiar la posición y escala de los siguientes cuadros:|n|n- Cuadro del jugador|n- Cuadro del objetivo|n- Cuadro del Buffs|n- Cuadro del centro del widget|n- Cuadro del fantasma|n- Barra del temporizador|n- Barra de poder del jugador"
