...
L["If checked, talking mounts will be muted.|n|nThis applies to Ban-Lu."] = "勾选后，将屏蔽那些乱说话的坐骑。|n|n就是你，武僧的职业坐骑班路。"
...
L["If checked, talking mounts will be muted.|n|nThis applies to Ban-Lu."] = "勾選後，發聲的坐騎將被靜音。|n|n這適用於Ban-Lu。"
...
L["If checked, talking mounts will be muted.|n|nThis applies to Ban-Lu."] = "Если установлен этот флажок, говорящие ездовые животные больше не будут разговаривать.|n|nЭто относится к Бань-Лу, спутнику великого мастера."
...
L["If checked, talking mounts will be muted.|n|nThis applies to Ban-Lu."] = "말타기 대화가 음소거 됩니다. 반루에 적용."
