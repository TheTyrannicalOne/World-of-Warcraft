...
L["If checked, most of the Mekgineer's Chopper and Mechano Hog sounds will be muted."] = "勾選後，大部分機械直升機以及機械豬的音效將會靜音。"
...
L["If checked, most of the Mekgineer's Chopper and Mechano Hog sounds will be muted."] = "Если флажок установлен, то большинство звуков Анжинерского чоппера и Механоцикла будут отключены."
...
L["If checked, the spell fizzle sounds will be muted."] = [=[Если флажок установлен, то звуки заклинаний будут отключены.
]=]
