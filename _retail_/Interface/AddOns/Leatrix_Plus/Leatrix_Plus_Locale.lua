...
L["Skip instance movies automatically"] = "Skip instance movies automatically"
L["Skyreach"] = "通天峰"
L["Slave Pens"] = "奴隶围栏"
L["Sniffing"] = "喘息声"
L["Social"] = "社交信息"
...
L["Find Item"] = "搜尋物品"
L["Firelands"] = "火源之界"
L["Fix Blizzard's NO QUALITY LOOT spam"] = "修復暴雪的無品質戰利品垃圾訊息"
L["Fizzle"] = "嘶嘶聲"
...
L["If checked, movies played inside instances will be skipped automatically."] = "勾選後，在副本內播放的動畫將被自動跳過。"
...
L["If checked, the Lucille's Sewing Needle transform (witch) will be removed when applied."] = "勾選後，應用時將移除Lucille的縫紉針變形(女巫)。"
...
L["If checked, the NO QUALITY LOOT spam which Blizzard added to Dragonflight will be hidden.|n|nIn Dragonflight, Blizzard added code to the game that spams you with NO QUALITY LOOT messages when you loot items.  With faster looting, messages are more frequent.|n|nThis setting hides this pointless spam by replacing Blizzard's looting code.  If you are using a loot frame replacement addon, you may need to uncheck this setting."] = "勾選後，被暴雪在巨龍崛起加入的無品質戰利品垃圾訊息將被隱藏。|n|n巨龍崛起，暴雪在遊戲中添加了代碼，當您拾取物品時，它會向您發送無品質戰利品的垃圾訊息。隨著拾取速度的加快，訊息也更加頻繁。|n|n此設置通過替換暴雪的拾取代碼來隱藏這些毫無意義的垃圾訊息。如果您使用的是戰利品框架替換插件，則可能需要取消選中此設置。"
...
L["If checked, the Turkey transform (Pilgrim's Bounty) will be removed when applied."] = "勾選後，火雞的變形將在應用後移除。"
...
L["Skip instance movies automatically"] = "自動跳過副本動畫"
L["Skyreach"] = "擎天峰"
L["Slave Pens"] = "奴隸監牢"
L["Sniffing"] = "嗅聞"
L["Social"] = "社交訊息"
...
L["Fix Blizzard's NO QUALITY LOOT spam"] = "Исправить спам от Blizzard НЕТ КАЧЕСТВА ДОБЫЧИ"
L["Fizzle"] = "Шипение"
...
L["If checked, the NO QUALITY LOOT spam which Blizzard added to Dragonflight will be hidden.|n|nIn Dragonflight, Blizzard added code to the game that spams you with NO QUALITY LOOT messages when you loot items.  With faster looting, messages are more frequent.|n|nThis setting hides this pointless spam by replacing Blizzard's looting code.  If you are using a loot frame replacement addon, you may need to uncheck this setting."] = "Если флажок установлен, спам от Blizzard НЕТ КАЧЕСТВА ДОБЫЧИ добавленный в Dragonflight будет скрыт|n|nВ Dragonflight, Blizzard добавили код в игру который спамит вам сообщение НЕТ КАЧЕСТВА ДОБЫЧИ, когда вы подбираете предметы. С быстрым сбором, сообщения появляются очень часто.|n|nЭта настройка скрывает бессмысленный спам замены кода лута Blizzard. Если вы используете другие аддоны для отображения лута, вы должны отключить эту опцию."
...
L["If checked, the Turkey transform (Pilgrim's Bounty) will be removed when applied."] = "Если флажок установлен, превращение в индейку (Пиршество странников) будет удалено при применении."
...
L["Skip instance movies automatically"] = "Автоматически пропускать видеоролики в подземелье"
...
L["Save profession filters"] = "Speicher Berufs-Filter"
L["Scale"] = "Rahmen"
...
L["Fix Blizzard's NO QUALITY LOOT spam"] = "Fixer me spam de Blizzard NO QUALITY LOOT"
...
L["If checked, dragging the General chat tab while the chat frame is locked will expand the chat frame upwards.|n|nIf the chat frame is unlocked, dragging the General chat tab will move the chat frame."] = "Si coché, faire glisser l'onglet de chat général alors que le cadre de chat est verrouillé étirera le cadre vers le haut.|n|nSi le cadre de chat est déverrouillé, faire glisser l'onglet de chat général déplacera le cadre."
...
L["If checked, movies played inside instances will be skipped automatically."] = "Si coché, les vidéos lus à l'intérieur des instances seront automatiquement ignorés."
...
L["If checked, profession filter settings will be saved for the remainder of your login session."] = "Si coché, les paramètres du filtre de profession seront enregistrés pour le reste de votre session de connexion."
L["If checked, quests will be selected, accepted and turned-in automatically.|n|nQuests which have a gold, currency or crafting reagent requirement will not be turned-in automatically.|n|nYou can hold the shift key down when you talk to a quest giver to override this setting."] = "Si coché, les quêtes seront sélectionnées, acceptées et rendues automatiquement.|n|nLes quêtes nécessitant de l'or, de la monnaie ou des réactifs d'artisanat ne seront pas rendues automatiquement.|n|nVous pouvez maintenir la touche Maj enfoncée lorsque vous parlez à un donneur de quête pour remplacer ce paramètre."
...
L["If checked, the Lucille's Sewing Needle transform (witch) will be removed when applied."] = "Si coché, la transformation de l'Aiguille à coudre de Lucille (sorcière) sera supprimée lors de son application."
...
L["If checked, the NO QUALITY LOOT spam which Blizzard added to Dragonflight will be hidden.|n|nIn Dragonflight, Blizzard added code to the game that spams you with NO QUALITY LOOT messages when you loot items.  With faster looting, messages are more frequent.|n|nThis setting hides this pointless spam by replacing Blizzard's looting code.  If you are using a loot frame replacement addon, you may need to uncheck this setting."] = "Si coché, le spam NO QUALITY LOOT que Blizzard a ajouté à Dragonflight sera masqué.|n|nDans Dragonflight, Blizzard a ajouté au jeu un code qui vous spamme avec des messages NO QUALITY LOOT lorsque vous récupérez des objets. Avec un pillage plus rapide, les messages sont plus fréquents.|n|nCe paramètre cache ce spam inutile en remplaçant le code de pillage de Blizzard. Si vous utilisez un module complémentaire de remplacement de cadre de butin, vous devrez peut-être décocher ce paramètre."
...
L["If checked, the Turkey transform (Pilgrim's Bounty) will be removed when applied."] = "Si coché, la transformation en Dinde (Les Bienfaits du pèlerin) sera supprimée lors de son application."
...
L["Save profession filters"] = "Enregistrer les filtres de métier"
L["Scale"] = "Échelle"
...
L["Skip instance movies automatically"] = "Ignorer automatiquement les vidéos pendant les instances"
