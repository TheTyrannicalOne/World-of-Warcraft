...
L["If checked, the Dragonflight profession transforms will be removed when applied.|n|nThis does not apply to fishing."] = "勾選後，巨龍崛起專業外型在應用時將被刪除。|n|n這不適用於釣魚。"
...
L["If checked, the Dragonflight profession transforms will be removed when applied.|n|nThis does not apply to fishing."] = "Si cette case est cochée, les transformations des professions de Dragonflight seront supprimées lorsqu'elles seront appliquées.|n|nCela ne s'applique pas à la pêche."
