...
L["If checked, you will be able to change the position and scale of the following frames:|n|n- Player frame|n- Target frame|n- Widget top center frame|n- Ghost frame|n- Timer bar"] = "勾选后，你可以调整下列框体的位置和缩放：|n|n- 玩家框体|n- 目标框体|n- 顶部信息框|n- 灵魂框体|n- 计时条"
...
L["If checked, you will be able to change the position and scale of the following frames:|n|n- Player frame|n- Target frame|n- Widget top center frame|n- Ghost frame|n- Timer bar"] = "勾選後，您將可以變更以下框架的位置與大小：|n|n- 玩家框架|n- 目標框架|n- 頂部中央組件框架|n- 靈魂框架|n- 計時條。"
...
L["If checked, you will be able to change the position and scale of the following frames:|n|n- Player frame|n- Target frame|n- Widget top center frame|n- Ghost frame|n- Timer bar"] = "다음 프레임의 위치와 스케일을 변경할 수 있습니다:|n- 플레이어 프레임 |n- 대상 프레임 |n- 위젯 상단 중앙 프레임 |n- 고스트 프레임 |n- 타이머 바"
...
L["Customise minimap"] = "Personalizar el minimapa"
L["Dalaran"] = "Dalaran"
...
L["Manage tooltip"] = "Gestionar los tooltips"
