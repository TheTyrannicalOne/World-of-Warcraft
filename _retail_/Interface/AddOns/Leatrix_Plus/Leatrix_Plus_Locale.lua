...
L["Click to resize the screen to fit between the top and bottom borders."] = "Нажмите, чтобы изменить размер экрана, чтобы он соответствовал верхней и нижней границам."
...
L["Disable pet automation"] = "Отключить автоматизацию домашних животных"
...
L["Drag to set the font size of mail text."] = "Перетащите, чтобы установить размер шрифта текста письма."
L["Drag to set the font size of quest text."] = "Перетащите, чтобы установить размер шрифта текста квеста."
...
L["If checked, a button will be added to the character sheet which will show your equipped item durability when you hover the pointer over it.|n|nIn addition, an overall percentage will be shown in the chat frame when you die."] = "Если отмечено, то в окне персонажа будет добавлена кнопка, которая покажет прочность экипировки при наведении указателя мыши на нее.|n|nКроме этого, общий процент будет показан в окне чата, если Вы умрете."
L["If checked, a group invite will be sent to anyone who whispers you with a set keyword as long as you are ungrouped, group leader or raid assistant."] = "Если отмечено, то групповое приглашение будет отправлено всем, кто шепчет вам с заданным ключевым словом, пока вы не объединены в группы, у вас должен быть статус лидера группы или помощника в рейде."
L["If checked, a group invite will be sent to anyone who whispers you with the keyword INV.|n|nYou need to be either ungrouped or party leader in your own group for this to work."] = "Если отмечено, то групповое приглашение будет отправлено всем, кто шепчет вам с ключевым словом INV.|n|nВы должны быть без группы, либо быть лидером группы в своей группе, чтобы это работало."
L["If checked, a master volume slider will be shown on the character sheet.|n|nThe volume slider can be placed in either of two locations on the character sheet.  To toggle between them, hold the shift key down and right-click the slider."] = "Если отмечено, то ползунок регулировки основной громкости будет отображен на окне персонажа.|n|nПолзунок может быть размещен в любом из двух местах на окне персонажа. Для переключения между ними, удерживая клавишу SHIFT щелкните правой кнопкой мыши по ползунку."
L["If checked, a minimap button will be available.|n|nClick - Toggle options panel.|n|nSHIFT/Left-click - Toggle music.|n|nSHIFT/Right-click - Toggle stopwatch.|n|nCTRL/Left-click - Toggle minimap target tracking.|n|nCTRL/Right-click - Toggle errors (if enabled).|n|nCTRL/SHIFT/Left-click - Toggle Zygor (if installed).|n|nCTRL/SHIFT/Right-click - Toggle windowed mode."] = "Если отмечено, то будет доступна кнопка на миникарте.|n|nКликните - чтобы вкл/выкл опции.|n|nSHIFT/ЛКМ - вкл/выкл музыку.|n|nSHIFT/ПКМ - вкл/выкл секундомер.|n|nCTRL/ЛКМ - вкл/выкл отслеживание на миникарте.|n|nCTRL/ПКМ - вкл/выкл ошибки (если были включены).|n|nCTRL/SHIFT/ЛКМ - вкл/выкл Zygor (если установлен).|n|nCTRL/SHIFT/ПКМ - вкл/выкл оконный режим."
L["If checked, additional functionality will be added to the auction house.|n|nBuyout only - create buyout auctions without filling in the starting price.|n|nGold only - set the copper and silver prices at 99 to speed up new auctions.|n|nFind item - search the auction house for the item you are selling.|n|nIn addition, the auction price type and duration settings will be saved account-wide."] = "Если отмечено, то на аукцион будут добавлены новые функции.|n|nТолько выкуп - создание аукционов выкупа без указания начальной цены.|n|nТолько золото - установите цены на медь и серебро 99, чтобы ускорить продажу новых лотов.|n|nНайти предмет - найдите в аукционе предмет, который вы продаете. Кроме того, настройка длительность лотов будет сохранена для всего аккаунта"
L["If checked, additional functionality will be added to the dressup frame.|n|nNude and tabard toggle buttons will be added, model positioning controls will be removed and special model animations will be disabled."] = [=[Если отмечено, то дополнительные функции будут добавлены в рамку одевания.|N|nБудут добавлены кнопки переключения без одежды и в ней, элементы управления позиционированием модели и специальные анимации модели будут отключены.
]=]
L["If checked, alert frames will not be shown."] = [=[Если отмечено, то фрейм предупреждения не будут отображаться.

]=]
L["If checked, all grey items in your bags will be sold automatically when you visit a merchant.|n|nYou can hold the shift key down when you talk to a merchant to override this setting."] = "Если отмечено, то все серые предмены в Ваших сумках будут проданы автоматически при посещении торговца.|n|nВы можете удерживать клавишу SHIFT во время общения с торговцем для временного игнорирования этой настройки."
L["If checked, backdrops will be tinted blue (friendly) or red (hostile)."] = "Если отмечено, то фон подсказки будет синим (дружественная цель) или красным (враждебная цель)."
L["If checked, battle pets which are automatically summoned will be dismissed within a few seconds.|n|nThis includes dragging a pet onto the first team slot in the pet journal and entering a battle pet team save command.|n|nNote that pets which are automatically summoned during combat will be dismissed when combat ends."] = "Если отмечено, то автоматически вызываемые боевые питомцы будут удалены в течение нескольких секунд.|N|nСюда входит перетаскивание питомца в первый слот команды в журнале питомцев и ввод команды сохранения команды боевого питомца. |N|nУкажите, что питомцы будут автоматически вызваны во время боя и будут отклонены после окончания боя."
L["If checked, BattleTag and Real ID friend requests will be automatically declined.|n|nEnabling this option will automatically decline any pending requests."] = "Если отмечено, то BattleTag и Real ID запросы дружбы будут автоматически отклоняться.|n|nВключение этого параметра автоматически отклонит любые ожидающие запросы."
L["If checked, chat frame buttons will be hidden.|n|nClicking chat tabs will automatically show the latest messages.|n|nUse the mouse wheel to scroll through the chat history.  Hold down SHIFT for page jump or CTRL to jump to the top or bottom of the chat history."] = "Если отмечено, то кнопки чата будут скрыты.|n|nЩелчек по вкладке чата автоматически покажет последние сообщения.|n|nИспользуйте колесо мыши для прокрутки истории чата. Удерживайте нажатой клавишу SHIFT для перехода на другую страницу чата или CTRL, для перехода к верхней или нижней части истории чата."
L["If checked, chat text will not fade out after a time period."] = "Если отмечено, то текст чата не будет исчезать после определенного периода времени."
L["If checked, class coloring will be used in the player frame, target frame and focus frame."] = "Если отмечено, то цвет по классам будет не только на фрейме игрока, но и на цели и ее цели."
L["If checked, confirmations will no longer appear when you choose a loot roll option or attempt to sell or mail a tradable item."] = "Если отмечено, то больше не будет предупреждений когда вы разыгрываете предмет или пересылаете по почте предмет, который можно передать."
L["If checked, converting a party group to a raid group will succeed even if there are low level characters in the group.|n|nEveryone in the group needs to have Leatrix Plus installed with this option enabled."] = [=[Если отмечено, преобразование группы участников в группу рейдов будет успешным, даже если в группе есть персонажи низкого уровня.|N|nВсе в группе должны иметь Leatrix Plus, установленный с этой опцией.
]=]
L["If checked, cooldown duration numbers will not be shown over the cooldowns.|n|nIf unchecked, cooldown duration numbers will be shown over the cooldowns if they are enabled in the game options panel ('ActionBars' menu)."] = "Если отмечено, то не будут отображаться цифры перезарядки.|n|nЕсли не отмечено, то цифры будут показываться поверх перезарядки (если они вкл. в игровых настройках)."
L["If checked, crafted items will no longer show the name of the crafter."] = "Если отмечено, то имя изготовителя больше не будет отображаться на изготовленной вещи."
L["If checked, damage and healing numbers in the player and pet portrait frames will be hidden."] = "Если отмечено, то значения урона и лечения на рамках игрока и питомца будут скрыты."
L["If checked, dragging the General chat tab while the chat frame is locked will expand the chat frame upwards.|n|nIf the chat frame is unlocked, dragging the General chat tab will move the chat frame."] = "Если отмечено, то перемещение вверх вкладки Общие (если изменение размера чата заблокировано) расширит форму чата.|n|nЕсли изменение размеров чата разблокировано, перемещение вкладки Общие приведет к перемещению окна чата."
L["If checked, duel requests will be blocked unless the player requesting the duel is in your friends list or guild."] = "Если отмечено, то запросы на дуэль будут заблокированы (кроме запросов из вашей гильдии и из списка друзей)."
L["If checked, emote sounds will be silenced while your character is:|n|n- resting|n- in a pet battle|n- at the Halfhill Market|n- at the Grim Guzzler|n|nEmote sounds will be enabled when none of the above apply."] = "Если отмечено, то звуки эмоций будут заглушаться, пока ваш персонаж отдыхает или находится на \"Рынке Полугорья\" и Трактир \"Угрюмый обжора\".|n|nВ любое другое время звуки будут включены, когда ничего из вышеперечисленного не применимо."
L["If checked, enemy nameplates will be shown during combat and hidden when combat ends."] = "Если отмечено, то индикаторы здоровья будут отображены только во время боя и скрыты после его завершения."
L["If checked, group invites will only be sent to friends and guild members.|n|nIf unchecked, group invites will be sent to everyone."] = "Если отмечено, то групповые приглашения будут отправляться только друзьям и членам гильдии.|n|nЕсли флажок снят, групповые приглашения будут отправляться всем."
L["If checked, guild ranks will be shown for players in your guild."] = "Если отмечено, то ранг в гильдии будет отображаться для игроков в Вашей гильдии."
L["If checked, most error messages (such as 'Not enough rage') will not be shown.  Some important errors are excluded.|n|nIf you have the minimap button enabled, you can hold down the control key and right-click it to toggle error messages without affecting this setting."] = "Если отмечено, то большинство сообщений об ошибках (например, «Недостаточно ярости») не будут отображаться. Некоторые важные ошибки останутся.|n|nЕсли у вас включена кнопка на мини-карте, вы сможете удерживать CTRL и нажать ПКМ, чтобы вкл/выкл сообщения ошибка, не трогая данную настройку."
L["If checked, party invitations from friends or guild members will be automatically accepted unless you are queued in Dungeon Finder."] = [=[Если отмечено, то приглашения в группу от друзей или членов гильдии будут автоматически приниматься, если вы не поставлены в очередь в поиск подземелья.
]=]
L["If checked, party invitations will be blocked unless the player inviting you is in your friends list or guild."] = "Если отмечено, то приглашения в группу будут заблокированы, если игрок, приглашающий вас, не будет в вашем списке друзей или гильдии."
L["If checked, pet battle duel requests will be blocked unless the player requesting the duel is in your friends list or guild."] = [=[Если отмечено, то запросы на дуэли с боевыми питомцами будут заблокированы, если игрок, запрашивающий дуэль, не будет в вашем списке друзей или гильдии.
]=]
L["If checked, profession filter settings will be saved for the remainder of your login session."] = "Если отмечено, то настройки фильтра профессий будут сохраняться до конца сеанса входа в систему."
L["If checked, quests will be selected, accepted and turned-in automatically.|n|nQuests which have a gold, currency or crafting reagent requirement will not be turned-in automatically.|n|nYou can hold the shift key down when you talk to a quest giver to override this setting."] = "Если отмечено, то квесты будут приниматься и завершаться автоматически.|n|nКвесты где нужно золото не будут автоматически завершаться.|n|nВы так же можете удерживать клавишу Shift, перед тем как говорить с НПС, чтобы временно игнорировать данную настройку."
L["If checked, raid chat and instance chat will both be colored blue (to match the default party chat color)."] = "Если отмечено, то чаты рейдов и подземелий будут окрашены в синий цвет (чтобы соответствовать цвету чата группы по умолчанию)."
L["If checked, repair costs will be taken from guild funds for characters that are guilded and have permission to repair."] = "Если отмечено, то затраты на ремонт будут взяты из банка гильдии для персонажей, которые являются членами гильдии и имеют разрешение на ремонт."
L["If checked, requests initiated by your party leader to join the Dungeon Finder queue will be automatically accepted if the party leader is in your friends list or guild.|n|nThis option requires that you have selected a role for your character in the Dungeon Finder window."] = "Если отмечено, то запросы, инициированные лидером вашей группы на присоединение к очереди поиска подземелий, будут автоматически приниматься, если лидер группы находится в вашем списке друзей или гильдии.|N|nЭтот параметр требует, чтобы вы выбрали роль своего персонажа в окне поиска подземелий."
L["If checked, resurrection requests will be accepted automatically as long as the player resurrecting you is not in combat.|n|nResurrection requests from a Brazier of Awakening or a Failure Detection Pylon will not be accepted automatically."] = [=[Если отмечено, то подтверждение воскрешения будет происходить автоматически, за исключением, если игрок который вас воскресил не находится в бою.|n|nПодтверждение воскрешения от "Жаровня пробуждения" и "Пилона для обнаружения проблем" не будут приняты автоматически.
 


]=]
L["If checked, spell IDs will be shown in buff icon tooltips located in the buff frame and under the target frame."] = "Если отмечено, то во всплывающих подсказках на фрейме с бафами, а также на целях персонажа будут отображаться ID заклинаний."
L["If checked, sticky chat will be disabled.|n|nNote that this does not apply to temporary chat windows."] = "Если отмечено, то липкий чат будет отключен.|n|nОбратите внимание, что это не относится к временным окнам чата или Battle.net разговорам."
L["If checked, summon requests will be accepted automatically unless you are in combat."] = "Если отмечено, то запросы призыва будут приниматься автоматически, если вы не в бою."
L["If checked, the addon list (accessible from the game menu) will show character based addons by default."] = "Если отмечено, то список модификаций (доступный из меню игры) будет по умолчанию отображаться для Вашего текущего персонажа."
L["If checked, the amount of time it takes to auto loot creatures will be significantly reduced."] = [=[Если отмечено, то время поднятие добычи значительно уменьшится.

]=]
L["If checked, the backpack clean-up button and the bank frame clean-up button will not be shown."] = "Если отмечено, то кнопка сортировки вещей в сумках и в банке отображаться не будет."
L["If checked, the boss banner will not be shown.|n|nThe boss banner appears when a boss is defeated.  It shows the name of the boss and the loot that was distributed."] = "Если отмечено, то баннер босса отображаться не будет.|n|nЭтот баннер обычно появляется после победы над боссом.  Он показывает имя босса и полученную с него добычу."
L["If checked, the button to toggle the raid container frame will be shown just above the raid management frame (left side of the screen) instead of in the raid management frame itself.|n|nThis allows you to toggle the raid container frame without needing to open the raid management frame."] = "Если отмечено, то кнопка для переключения контейнера рейд будет отображена над его окном управления (на левой стороне экрана), а не на самом окне управления.|n|nЭто позволит переключать рамку контейнера рейда без необходимости открывать окно его управления."
L["If checked, the clock will be hidden."] = "Если отмечено, то часы не будут отображаться."
L["If checked, the combat log will be hidden.|n|nThe combat log must be docked in order for this option to work.|n|nIf the combat log is undocked, you can dock it by dragging the tab (and reloading your UI) or by resetting the chat windows (from the chat menu)."] = "Если отмечено, то журнал боя будет скрыт.|n|nЖурнал боя должен быть присоединён к основному окну чата для того, чтобы этот параметр работал.|n|nЕсли журнал боя откреплён, Вы можете закрепить его перетащив на вкладку чата (после этого необходимо перезагрузить UI) или сбросить настройки окна чата (из соответствующего меню)."
L["If checked, the 'Display only character achievements to others' setting in the game options panel ('Social' menu) will be permanently checked and locked."] = "Если отмечено, то параметр 'Позволить другим просматривать только достижения персонажа' в панели настроек игрового меню ('Общение') будет выбран и заблокирован."
L["If checked, the editbox will be moved to the top of the chat frame."] = "Если отмечено, то поле ввода текста будет перемещено в верхнюю часть окна чата."
L["If checked, the game world will be resized to fit between the top and bottom borders.|n|nNote that if you enable this setting, the transparency slider will no longer affect the top and bottom borders."] = "Если отмечено, то размер игрового мира будет изменен в соответствии с верхней и нижней рамкой.|n|nОбратите внимание, что если вы включите этот параметр, то уровень прозрачности больше не будет влиять на верхнюю и нижнюю рамку."
L["If checked, the gossip window will not be shown when you talk to an active garrison bodyguard.|n|nYou can hold the shift key down when you talk to a bodyguard to override this setting."] = "Если отмечено, то окно разговоров не будет отображаться, когда Вы будете говорить с активным гарнизонным телохранителем.|n|nВы можете удерживать клавишу SHIFT во время общения для временного игнорирования этой настройки."
L["If checked, the grey screen of death and the netherworld effect will be disabled."] = "Если отмечено, то серый экран смерти и другие эффекты будут отключены."
L["If checked, the interface button sound, the chat frame tab click sound and the game menu toggle sound will be muted."] = [=[Если отмечено, то звук кнопки интерфейса, звук щелчка вкладки фрейма чата и звук переключения меню игры будут отключены.
]=]
L["If checked, the level-up display will not be shown.|n|nThe level-up display shows encounter objectives, level-ups, pet battle rewards, etc."] = "Если отмечено, то окно увеличения уровня не будет отображено.|n|nЭто окно обычно отображает цели подземелья, повышение уровня, награды за битву питомцев и др."
L["If checked, the main bar gryphons will not be shown."] = "Если отмечено, то грифоны на главном окне отображаться не будут."
L["If checked, the order hall command bar will not be shown."] = [=[Если отмечено, то панель командного стола классового оплота не будет отображаться.
]=]
L["If checked, the screen glow will be disabled.|n|nEnabling this option will also disable the drunken haze effect."] = [=[Если отмечено, то свечение экрана будет отключено.|n|nВключение этой опции также отключит эффект "пьяной" дымки.

]=]
L["If checked, the social button and quick-join notification will be hidden."] = [=[Если отмечено, то кнопка соцсети и уведомление о быстром присоединении будут скрыты.
]=]
L["If checked, the spell fizzle sounds will be muted."] = [=[Если отмечено, то звуки заклинаний будут приглушены.
]=]
L["If checked, the stance bar will not be shown."] = "Если отмечено, то окно стоек отображаться не будет."
L["If checked, the talking frame will not be shown.|n|nThe talking frame normally appears in the lower portion of the screen when certain NPCs communicate with you."] = "Если отмечено, то окно разговоров не будет отображено.|n|nОкно разговоров появляется обычно в нижней части экрана, в процессе общения с некоторыми НПС."
L["If checked, the tooltip will be color coded and you will be able to modify the tooltip layout and scale."] = "Если отмечено, то всплывающие подсказки будут выделены цветом, и у Вас появится возможность изменять их расположение и масштаб."
L["If checked, the tracking button will be merged with the calendar button.|n|nLeft-click the tracking button to show the tracking menu or right-click it to show the calendar."] = "Если отмечено, то кнопка отслеживания будет объединена с кнопкой календаря.|N|nКликните ЛКМ по кнопке отслеживания, чтобы вызвать меню отслеживания, или кликнуть ПКМ, чтобы отобразить календарь."
L["If checked, the worgen sniffing sounds will be muted."] = "Если отмечено, то звуки когда ворген нюхает будут отключены."
L["If checked, the zone text bar will be hidden.  The tracking button tooltip will show zone information."] = [=[Если отмечено, то название зоны будет скрыто (но все ещё будет появляться во всплывающей подсказке).

]=]
L["If checked, the zoom buttons will be hidden.  You can use the mousewheel to zoom regardless of this setting."] = "Если отмечено, то кнопки масштаба будут скрыты, но вы сможете использовать колесо мыши для увеличения независимо от этой настройки."
L["If checked, tooltips for world units will be hidden during combat.|n|nYou can hold the shift key down to override this setting."] = "Если отмечено, то подсказки для мировых объектов будут скрыты во время боя.|n|nВы можете удерживать клавишу SHIFT для временного игнорирования этой настройки."
L["If checked, unit targets will be shown."] = "Если отмечено, то будет отображаться цель цели."
L["If checked, Wowhead links will be shown in the world map frame and the achievements frame."] = [=[Если отмечено, то ссылки на Wowhead будут отображаться во фрейме карты мира и во фрейме достижений.
]=]
L["If checked, you can hold down the alt key while opening a gossip window to automatically select a single gossip option."] = "Если отмечено, то вы можете удерживать клавишу Alt при открытии окна диалога, чтобы автоматически выбрать один из вариантов ответа."
L["If checked, you can hold down the control key and click a chat tab to view recent chat in a copy-friendly window."] = "Если отмечено, то вы можете удерживать нажатой клавишу Сtrl и кликнуть на вкладку чата, чтобы просмотреть недавний чат в окне, из которого вы можете легко скопировать текст."
L["If checked, you can open Leatrix Plus by pressing CTRL/Z."] = "Если отмечено, то вы сможете открыть Leatrix Plus, нажав CTRL/Z."
L["If checked, you can press the arrow keys to move the insertion point left and right in the chat frame.|n|nIf unchecked, the arrow keys will use the default keybind setting."] = "Если отмечено, то вы сможете нажимать кнопки со стрелками для перемещения курсора влево и вправо в окне чата.|n|nЕсли не отмечено, то клавиши со стрелками будут использовать настройки назначения клавиш по умолчанию."
L["If checked, you will be able to cancel cinematics without being prompted for confirmation."] = "Если отмечено, то вы сможете пропускать ролики без подтверждения."
L["If checked, you will be able to change the font size of quest text.|n|nEnabling this option will also change the text size of other frames which inherit the same font (such as the Dungeon Finder frame)."] = "Если отмечено, то вы сможете изменить размер шрифта текста задания.|n|nВключение этого параметра будет влиять на размер текста других окон, наследующих один и тот же шрифт (например, окно поиска подземелий)."
L["If checked, you will be able to change the font size of standard mail text.|n|nThis does not affect mail created using templates (such as auction house invoices)."] = "Если отмечено, то вы сможете изменить стандартный размер шрифта текста письма."
L["If checked, you will be able to change the position and scale of the following frames:|n|n- Player frame|n- Target frame|n- Buffs frame|n- Widget top center frame|n- Ghost frame|n- Timer bar|n- Player power bar"] = [=[Если отмечено, то вы сможете изменить положение и масштаб следующих фреймов:|n|n- рамка игрока|n- рамка цели|n- рамка баффов|n- виджет верхней центральной рамки|n- рамка призрака|n- панель таймера|n- панель сил игрока 



]=]
L["If checked, you will be able to create a viewport.  A viewport adds adjustable black borders around the game world.|n|nThe borders are placed on top of the game world but under the UI so you can place UI elements over them."] = "Если отмечено, то вы сможете создать темные полосы. Они накладываются на игровой мир.|n|nПолосы располагаются над игровым миром, но под интерфейсом, так что Вы сможете поместить элементы пользовательского интерфейса над темными полосами."
L["If checked, you will be able to customise the minimap."] = [=[Если отмечено, то вы можете настроить миникарту.

]=]
L["If checked, you will be able to drag the chat frame to the edge of the screen."] = "Если отмечено, то вы сможете переместить рамку чата к краю экрана."
L["If checked, you will be able to mute a selection of game sounds."] = "Если отмечено, то вы можете отключить звук в игре."
L["If checked, you will be able to place up to five beneficial cooldown icons above the target frame."] = "Если отмечено, то вы сможете разместить до пяти иконок восстановления над фреймом цели."
L["If checked, you will be able to reposition the tooltip."] = "Если отмечено, то вы сможете изменить положение всплывающей подсказки."
L["If checked, you will be able to save your current battle pet team (including abilities) to a single command.|n|nA button will be added to the Pet Journal.  Clicking the button will toggle showing the assignment command for your current team.  Pressing CTRL/C will copy the command to memory.|n|nYou can then paste the command (with CTRL/V) into the chat window or a macro to instantly assign your team."] = "Если отмечено, то вы сможете сохранить текущий состав питомцев (включкая способности) в одну команду.|n|nКнопка будет добавлена в журнал питомцев. Щелчек по кнопке покажет дополнительные операции для Вашей текущей команды. При нажатии CTRL/C команда будет скопирована в память.|n|nВы можете вставить команду (с помощью CTRL/V) в окно чата или макроса для мгновенного выбора команды."
L["If checked, you will be able to set the density of weather effects."] = "Если отмечено, вы сможете установить плотность погодных эффектов."
L["If checked, you will be able to show a rare, elite or rare elite chain around the player frame."] = "Если отмечено, то вы сможете отобразить редкий, элитный или редкий элитный контур вокруг рамки игрока."
L["If checked, you will be able to zoom out to a greater distance."] = "Если отмечено, то вы сможете максимально отдалять камеру."
L["If checked, you will release automatically after you die in Ashran, Tol Barad (PvP), Wintergrasp or any battleground.|n|nYou will not release automatically if you have the ability to self-resurrect (soulstone, reincarnation, etc)."] = "Если отмечено, то вы будете автоматически возрождаться после смерти в Ашране, Тол Бараде (PvP), Озеро Ледяных Оков или на любом другом поле битвы.|N|nВы не возродитесь автоматически, если у вас есть способность к само возрождению(камень душ, реинкарнация и т. д.)."
L["If checked, your bags will not be opened or closed automatically when you interact with a merchant, bank or mailbox."] = "Если отмечено, то ваши сумки не будут открываться или закрываться автоматически, когда Вы взаимодействуете с торговцами, банком или почтовым ящиком."
L["If checked, your chat history will increase to 4096 lines.  If unchecked, the default will be used (128 lines).|n|nEnabling this option may prevent some chat text from showing during login."] = "Если отмечено, то история чата увеличится до 4096 линий. Если флажок не установлен, по умолчанию будет использоваться (128 линий).|n|nВключение этого параметра может помешать отображению некоторого текста во время входа в систему."
L["If checked, your gear will be repaired automatically when you visit a suitable merchant.|n|nYou can hold the shift key down when you talk to a merchant to override this setting."] = "Если отмечено, то ваше снаряжение будет починено автоматически, когда вы поговорите с подходящим торговцем.|n|nВы можете удерживать клавишу Shift, перед разговором, чтобы временно игнорировать данную настройку."
L["If checked, zone text will not be shown (eg. 'Ironforge')."] = "Если отмечено, то текст названия зоны не будет отображаться (напр., 'Стальгорн')."
...
L["Mute Game Sounds"] = "Приглушенные звуки игры"
L["Mute game sounds"] = "Приглушить звуки игры"
...
L["Set weather density"] = "Установите плотность погоды"
...
L["Off"] = "끄기"
L["Okay, disable screen adjust for me"] = "화면 조정 비활성"
