...
L["If checked, a group invite will be sent to anyone who whispers you with a set keyword.|n|nYou need to be either not in a group or party leader in your own group for this to work."] = "勾选后，会自动邀请给你发送你所预设关键词的密语的玩家。|n|n你必须不在队伍中，或者是队长时才能生效此项功能。"
...
L["If checked, a group invite will be sent to anyone who whispers you with a set keyword.|n|nYou need to be either not in a group or party leader in your own group for this to work."] = "勾選後，密語你設置的關鍵字的任何人將收到隊伍邀請。|n|n你需要在一個隊伍中才能生效不管你是隊員或是隊長。"
...
L["Hide order hall bar"] = "Скрыть порядок зала бар"
...
L["If checked, a group invite will be sent to anyone who whispers you with a set keyword.|n|nYou need to be either not in a group or party leader in your own group for this to work."] = " 귓속말 초대한 사람에게 설정된 키워드를 보냅니다. 이 기능을 사용하려면 자신의 그룹에 속한 그룹 또는 파티 장이 아니어야합니다."
