...
L["If checked, additional functionality will be added to the dressup frame.|n|nNude and tabard toggle buttons will be added, model positioning controls will be removed and special model animations will be disabled."] = "Если флажок установлен, то в примерочной появятся дополнительные функции.|n|nБудут добавлены кнопки снятия всей одежды и надевание всей одежды, а элементы управления позиционированием модели и специальные анимации модели будут отключены."
...
L["If checked, crafted items will no longer show the name of the crafter."] = "Если флажок установлен, на изготовленной вещи больше не будет отображаться имя изготовителя."
...
L["If checked, group invites will only be sent to friends and guild members.|n|nIf unchecked, group invites will be sent to everyone."] = "Если флажок установлен, то групповые приглашения будут отправляться только друзьям и членам гильдии.|n|nЕсли флажок снят, групповые приглашения будут отправляться всем."
...
L["If checked, summon requests will be accepted automatically unless you are in combat."] = "Если флажок установлен, то запросы призыва будут приниматься автоматически, если вы не в бою."
...
L["If checked, the amount of time it takes to auto loot creatures will be significantly reduced."] = [=[Если флажок установлен, то время поднятие добычи значительно уменьшится.
...
L["If checked, the game world will be resized to fit between the top and bottom borders.|n|nNote that if you enable this setting, the transparency slider will no longer affect the top and bottom borders."] = "Если флажок установлен, то размер игрового мира будет изменен в соответствии с верхней и нижней рамкой.|n|nПримечание: если вы включили эту настройку, то уровень прозрачности больше не будет влиять на верхнюю и нижнюю рамку."
...
L["If checked, the social button and quick-join notification will be hidden."] = [=[Если флажок установлен, то кнопка соцсети и уведомление о быстром присоединении будут скрыты.
]=]
L["If checked, the spell fizzle sounds will be muted."] = [=[Если флажок установлен, то звуки заклинаний будут приглушены.
]=]
...
L["If checked, the tracking button will be merged with the calendar button.|n|nLeft-click the tracking button to show the tracking menu or right-click it to show the calendar."] = "Если флажок установлен, то кнопка \"Отслеживание\", что у миникарты, будет объединена с кнопкой \"Календарь\".|n|nВыполните щелчок левой кнопкой мыши по объединенной кнопке, чтобы вызвать меню отслеживания или правой кнопкой мыши, чтобы открыть календарь."
L["If checked, the worgen sniffing sounds will be muted."] = "Если флажок установлен, то будут отключены звуки когда ворген нюхает."
