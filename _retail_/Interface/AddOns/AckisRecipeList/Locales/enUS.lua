...
L["DISCOVERY_INSC_DREAMS"] = "Obtained randomly via Research: Ink of Dreams, or from Research: Warbinder's Ink if you have all Glyphs made from Warbinder's Ink."
L["DISCOVERY_INSC_ETHEREAL"] = "Obtained randomly via Research: Ethereal Ink, or from Research: Warbinder's Ink if you have all Glyphs made from Warbinder's Ink."
L["DISCOVERY_INSC_JADEFIRE"] = "Obtained randomly via Research: Jadefire Ink, or from Research: Warbinder's Ink if you have all Glyphs made from Warbinder's Ink."
L["DISCOVERY_INSC_LIONS"] = "Obtained randomly via Research: Lion's Ink, or from Research: Warbinder's Ink if you have all Glyphs made from Warbinder's Ink."
L["DISCOVERY_INSC_MIDNIGHT"] = "Obtained randomly via Research: Midnight Ink, or from Research: Warbinder's Ink if you have all Glyphs made from Warbinder's Ink."
L["DISCOVERY_INSC_MOONGLOW"] = "Obtained randomly via Research: Moonglow Ink, or from Research: Warbinder's Ink if you have all Glyphs made from Warbinder's Ink."
...
L["DROMAN"] = "Take the Fae Net that is resting on the table to the right of Droman Downblossom. Then go to South of Val'sharah (Legion zone) and use the net while targetting a Vale Flitter (critter). Then quickly come back to Droman Downblossom and get the pattern for the glyph."
