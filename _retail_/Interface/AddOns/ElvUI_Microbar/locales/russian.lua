...
L["Show in game shop button, if disabled will show help button instead."] = "Отображать кнопку для открытия магазина. Если отключено, будет использоваться кнопка помощи."
