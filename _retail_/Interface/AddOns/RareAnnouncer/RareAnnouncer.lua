...
local mobs = {
  ...
  [72775] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["72775"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 64.6, coordsY = 72.8, lastRequest = 0 }, -- Bufo
  [73171] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["73171"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 61.6, coordsY = 48.4, lastRequest = 0 }, -- Champion of the Black Flame
  [72045] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["72045"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 25.2, coordsY = 36.0, lastRequest = 0 }, -- Chelon
  [73175] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["73175"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 54.6, coordsY = 53,   lastRequest = 0 }, -- Cinderfall
  [73854] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["73854"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 43.8, coordsY = 69.6, lastRequest = 0 }, -- Cranegnasher
  [73281] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["73281"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 25.8, coordsY = 23.2, lastRequest = 0 }, -- Dread Ship Vazuvius
  [73158] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["73158"]), minSpawn =  900, maxSpawn = 1800, coordsX = 0,    coordsY = 0,    lastRequest = 0 }, -- Emerald Gander
  [73279] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["73279"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 0,    coordsY = 0,    lastRequest = 0 }, -- Evermaw
  [73172] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["73172"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 47.8, coordsY = 38.8, lastRequest = 0 }, -- Flintlord Gairan
  [73282] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["73282"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 63.4, coordsY = 28.4, lastRequest = 0 }, -- Garnia
  [72970] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["72970"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 61.8, coordsY = 63,   lastRequest = 0 }, -- Golganarr
  [73161] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["73161"]), minSpawn =  900, maxSpawn = 1800, coordsX = 0,    coordsY = 0,    lastRequest = 0 }, -- Great Turtle Furyshell
  [72909] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["72909"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 40.6, coordsY = 81.6, lastRequest = 0 }, -- Gu'chi the Swarmbringer
  [73167] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["73167"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 0,    coordsY = 0,    lastRequest = 0 }, -- Huolon
  [73163] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["73163"]), minSpawn =  900, maxSpawn = 1800, coordsX = 0,    coordsY = 0,    lastRequest = 0 }, -- Imperial Python
  [73160] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["73160"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 0,    coordsY = 0,    lastRequest = 0 }, -- Ironfur Steelhorn
  [73169] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["73169"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 0,    coordsY = 0,    lastRequest = 0 }, -- Jakur of Ordon
  [72193] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["72193"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 0,    coordsY = 0,    lastRequest = 0 }, -- Karkanos
  [73277] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["73277"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 0,    coordsY = 0,    lastRequest = 0 }, -- Leafmender
  [73166] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["73166"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 0,    coordsY = 0,    lastRequest = 0 }, -- Monsterous Spineclaw
  [72048] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["72048"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 0,    coordsY = 0,    lastRequest = 0 }, -- Rattleskew
  [73157] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["73157"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 0,    coordsY = 0,    lastRequest = 0 }, -- Rock Moss
  [71864] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["71864"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 0,    coordsY = 0,    lastRequest = 0 }, -- Spelurk
  [72769] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["72769"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 0,    coordsY = 0,    lastRequest = 0 }, -- Spirit of Jadefire
  [73704] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["73704"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 0,    coordsY = 0,    lastRequest = 0 }, -- Stinkbraid
  [72808] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["72808"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 0,    coordsY = 0,    lastRequest = 0 }, -- Tsavo'ka <Ghost in the Darkness>
  [73173] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["73173"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 0,    coordsY = 0,    lastRequest = 0 }, -- Urdur the Cauterizer
  [73170] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["73170"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 0,    coordsY = 0,    lastRequest = 0 }, -- Watcher Osu
  [72245] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["72245"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 0,    coordsY = 0,    lastRequest = 0 }, -- Zesqua
  [71919] = { lastAnnounce = 0, killTime = -1, killAnnounced = 0, npcName = (L["71919"]), minSpawn = 1800, maxSpawn = 3600, coordsX = 0,    coordsY = 0,    lastRequest = 0 }, -- Zhu-Gon the Sour
  -- Testing
  --[73162] = { lastAnnounce = 0, killTime = -1, npcName = "Foreboding Flame"            , minSpawn = 2,    maxSpawn = 5,    coordsX = 0, coordsY = 0, lastRequest = 0 }, -- Foreboding Flame
}
...
local function GetChannelOwner(chanID)
  ...
  for i = 1, memberCount do
    local name, owner, _, _, _, _ = GetChannelRosterInfo(chanID, i)
    if (owner) then
      return name
    end
  end
...
local function JoinSyncChannels(self, elapsed)
  ...
  if (channelJoinCurrent > channelJoinDelay) then
    ...
    if (IsAddonMessagePrefixRegistered(syncChanNamePrefix) == false) then
      RegisterAddonMessagePrefix(syncChanNamePrefix)
    end
    ...
    if (IsAddonMessagePrefixRegistered(syncRCChanNamePrefix) == false) then
      RegisterAddonMessagePrefix(syncRCChanNamePrefix)
    end
...
local index = GetChannelName("General") -- Find General Channel for user
  if (msg ~= nil) then
      ...
      if (message == "Sync") then
        for syncRareIte = 1, #mobIDs do
          if ((mobs[mobIDs[syncRareIte]].killTime ~= nil) and
            ...
            SendAddonMessage(syncChanNamePrefix, "[".. syncChanNamePrefix .. "]" .. GetRareIdString(mobIDs[syncRareIte]) .. "_death_" .. tostring(mobs[mobIDs[syncRareIte]].killTime), "WHISPER", sender)
          end
        end
      -- Sync response
      else
...
local function ProcessChanRosterUpdate(chanID)
  ...
  if (name == syncChanNamePrefix) then
    ...
    if (needSync) then
      ...
      if (chanOwner ~= nil) then
        SendAddonMessage(syncChanNamePrefix, "Sync", "WHISPER", chanOwner)
      end
    end
  elseif (name == syncRCChanNamePrefix) then
    ...
    if (needRCSync) then
      ...
      local chanOwner = GetChannelOwner(chanID)
      if (chanOwner ~= nil) then
        SendAddonMessage(syncRCChanNamePrefix, "GetStatus", "WHISPER", chanOwner)
      end
    end
  end
