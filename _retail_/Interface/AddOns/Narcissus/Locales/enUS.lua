...
L["Minimap Tooltip Double Click"] = "Double-click";
L["Minimap Tooltip Left Click"] = "Left-click|r";
L["Minimap Tooltip To Open"] = "|cffffffffOpen the immersive paperdoll";
L["Minimap Tooltip Right Click"] = "Right-click |cffffffffHide this button";
